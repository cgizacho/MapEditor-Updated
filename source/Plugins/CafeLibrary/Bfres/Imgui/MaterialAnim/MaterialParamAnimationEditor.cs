...
namespace CafeLibrary
{
    public class MaterialParamAnimationEditor
    {
        ...
        {
            public Syroot.NintenTools.NSW.Bfres.ShaderParamType ParamType { get; set; }
        }
            ...
            BfresMaterialAnim.ParamAnimGroup paramGroup)
        {
            if (ImGui.CollapsingHeader(TranslationSource.GetText("TRACK_DATA") + "##track_d", ImGuiTreeNodeFlags.DefaultOpen))
            {
                ...
                if (ParamProperty.ParamType == Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float3 ||
                    ParamProperty.ParamType == Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float4)
                {
        ...
        static void UpdateParamInfo(BfresMaterialAnim anim, STAnimGroup paramGroup)
        {
            ...
            if (materials.Count > 0)
            {
                ...
                if (mat.ShaderParams.Any(x => x.Name == paramGroup.Name))
                    ParamProperty.ParamType = mat.ShaderParams.First(x => x.Name == paramGroup.Name).Type;
            }
        ...
        public static void RenderColorParamEditor(BfresMaterialAnim anim, BfresMaterialAnim.ParamAnimGroup paramGroup) {
            ...
            bool isTexSRT = ParamProperty.ParamType == Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrt ||
                ParamProperty.ParamType == Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrtEx;
        ...
        static void RenderInsertPanel(BfresMaterialAnim anim, BfresMaterialAnim.ParamAnimGroup paramGroup)
        {
            ...
            switch (ParamProperty.ParamType)
            {
                ...
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float4:
                    ...
                    break;
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrtEx:
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrt:
        ...
        static object GetInsertValue()
        {
            switch (ParamProperty.ParamType)
            {
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float: return floatInsert1;
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float2: return floatInsert2;
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float3: return floatInsert3;
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.Float4: return floatInsert4;
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrt:
                case Syroot.NintenTools.NSW.Bfres.ShaderParamType.TexSrtEx: 
        ...
        static void InsertKey(BfresMaterialAnim.ParamAnimGroup group, Syroot.NintenTools.NSW.Bfres.ShaderParamType type, float frame, object value)
        {
