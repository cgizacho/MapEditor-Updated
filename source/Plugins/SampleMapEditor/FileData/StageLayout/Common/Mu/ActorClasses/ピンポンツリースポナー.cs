...
{
	public class ピンポンツリースポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "ピンポンツリースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ピンポンツリースポナー(ピンポンツリースポナー other) : base(other)
		{
		...
		public override ピンポンツリースポナー Clone()
		{
			return new ピンポンツリースポナー(this);
		}
