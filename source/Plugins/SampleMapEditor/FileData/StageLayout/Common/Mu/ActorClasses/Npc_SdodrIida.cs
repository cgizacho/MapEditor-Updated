...
{
	public class Npc_SdodrIida : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsInitEventVisible", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematicWait", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsTakeOverVisible", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitASCommand", Category = "Npc_SdodrIida Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_SdodrIida(Npc_SdodrIida other) : base(other)
		{
		...
		public override Npc_SdodrIida Clone()
		{
			return new Npc_SdodrIida(this);
		}
