...
{
	public class GrindRail : MuObj
	{
		[BindGUI("IsCameraReset", Category = "GrindRail Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsLightModel", Category = "GrindRail Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOpen", Category = "GrindRail Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public bool _IsOpen
		{
			get
			{
		...
		[BindGUI("IsUseBase", Category = "GrindRail Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("LinkToRail", Category = "GrindRail Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GrindRail(GrindRail other) : base(other)
		{
			spl__GrindRailBancParam = other.spl__GrindRailBancParam.Clone();
		}

		public override GrindRail Clone()
		{
			return new GrindRail(this);
		}
