...
{
	public class DObj_Fld_SmallWorldWaterStorageTank : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Fld_SmallWorldWaterStorageTank Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Fld_SmallWorldWaterStorageTank() : base()
		{
		...
		public DObj_Fld_SmallWorldWaterStorageTank(DObj_Fld_SmallWorldWaterStorageTank other) : base(other)
		{
		...
		public override DObj_Fld_SmallWorldWaterStorageTank Clone()
		{
			return new DObj_Fld_SmallWorldWaterStorageTank(this);
		}
