...
{
	public class NpcVsJerry_SwimWear_02 : MuObj
	{
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_SwimWear_02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_SwimWear_02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		public NpcVsJerry_SwimWear_02() : base()
		{
		...
		public NpcVsJerry_SwimWear_02(NpcVsJerry_SwimWear_02 other) : base(other)
		{
			spl__OceanBindableHelperBancParam = other.spl__OceanBindableHelperBancParam.Clone();
		}

		public override NpcVsJerry_SwimWear_02 Clone()
		{
			return new NpcVsJerry_SwimWear_02(this);
		}
