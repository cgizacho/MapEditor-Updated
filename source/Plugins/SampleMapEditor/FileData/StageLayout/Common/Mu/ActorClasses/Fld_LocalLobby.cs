...
{
	public class Fld_LocalLobby : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_LocalLobby Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_LocalLobby(Fld_LocalLobby other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_LocalLobby Clone()
		{
			return new Fld_LocalLobby(this);
		}
