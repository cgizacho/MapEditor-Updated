...
{
	public class ShootingBoxLHard_EnemyBreakable : MuObj
	{
		[BindGUI("IsFreeY", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "ShootingBoxLHard_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ShootingBoxLHard_EnemyBreakable() : base()
		{
		...
		public ShootingBoxLHard_EnemyBreakable(ShootingBoxLHard_EnemyBreakable other) : base(other)
		{
		...
		public override ShootingBoxLHard_EnemyBreakable Clone()
		{
			return new ShootingBoxLHard_EnemyBreakable(this);
		}
