...
{
	public class SpongeRectangle : MuObj
	{
		[BindGUI("IsFreeY", Category = "SpongeRectangle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "SpongeRectangle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		public SpongeRectangle(SpongeRectangle other) : base(other)
		{
		...
		public override SpongeRectangle Clone()
		{
			return new SpongeRectangle(this);
		}
