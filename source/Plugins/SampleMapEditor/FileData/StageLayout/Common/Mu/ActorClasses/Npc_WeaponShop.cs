...
namespace SampleMapEditor
{
	public class Npc_WeaponShop : MuObj
	{
		...
		public Npc_WeaponShop(Npc_WeaponShop other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override Npc_WeaponShop Clone()
		{
			return new Npc_WeaponShop(this);
		}
