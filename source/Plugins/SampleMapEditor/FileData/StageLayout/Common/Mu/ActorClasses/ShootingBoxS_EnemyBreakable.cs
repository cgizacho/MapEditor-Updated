...
{
	public class ShootingBoxS_EnemyBreakable : MuObj
	{
		[BindGUI("IsFreeY", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "ShootingBoxS_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ShootingBoxS_EnemyBreakable() : base()
		{
		...
		public ShootingBoxS_EnemyBreakable(ShootingBoxS_EnemyBreakable other) : base(other)
		{
		...
		public override ShootingBoxS_EnemyBreakable Clone()
		{
			return new ShootingBoxS_EnemyBreakable(this);
		}
