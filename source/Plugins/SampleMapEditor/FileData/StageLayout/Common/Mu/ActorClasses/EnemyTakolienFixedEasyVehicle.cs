...
{
	public class EnemyTakolienFixedEasyVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "EnemyTakolienFixedEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakolienFixedEasyVehicle() : base()
		{
		...
		public EnemyTakolienFixedEasyVehicle(EnemyTakolienFixedEasyVehicle other) : base(other)
		{
		...
		public override EnemyTakolienFixedEasyVehicle Clone()
		{
			return new EnemyTakolienFixedEasyVehicle(this);
		}
