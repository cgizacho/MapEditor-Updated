...
{
	public class Fld_Kaisou04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Kaisou04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Kaisou04(Fld_Kaisou04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Kaisou04 Clone()
		{
			return new Fld_Kaisou04(this);
		}
