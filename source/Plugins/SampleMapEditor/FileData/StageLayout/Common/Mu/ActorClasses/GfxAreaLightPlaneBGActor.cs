...
{
	public class GfxAreaLightPlaneBGActor : MuObj
	{
		[BindGUI("Color", Category = "GfxAreaLightPlaneBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxAreaLightPlaneBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxAreaLightPlaneBGActor() : base()
		{
		...
		public GfxAreaLightPlaneBGActor(GfxAreaLightPlaneBGActor other) : base(other)
		{
			game__gfx__LocatorPrimitiveLightBancParam = other.game__gfx__LocatorPrimitiveLightBancParam.Clone();
		}

		public override GfxAreaLightPlaneBGActor Clone()
		{
			return new GfxAreaLightPlaneBGActor(this);
		}
