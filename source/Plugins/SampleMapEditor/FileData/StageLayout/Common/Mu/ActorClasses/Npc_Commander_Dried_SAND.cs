...
{
	public class Npc_Commander_Dried_SAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "Npc_Commander_Dried_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_Commander_Dried_SAND() : base()
		{
		...
		public Npc_Commander_Dried_SAND(Npc_Commander_Dried_SAND other) : base(other)
		{
		...
		public override Npc_Commander_Dried_SAND Clone()
		{
			return new Npc_Commander_Dried_SAND(this);
		}
