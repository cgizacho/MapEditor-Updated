...
{
	public class Fld_BigSlope00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigSlope00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigSlope00(Fld_BigSlope00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigSlope00 Clone()
		{
			return new Fld_BigSlope00(this);
		}
