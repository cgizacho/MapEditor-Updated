...
{
	public class GfxPointLightBGActor : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightBGActor() : base()
		{
		...
		public GfxPointLightBGActor(GfxPointLightBGActor other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightBGActor Clone()
		{
			return new GfxPointLightBGActor(this);
		}
