...
{
	public class DObj_SpikyChairSAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SpikyChairSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SpikyChairSAND() : base()
		{
		...
		public DObj_SpikyChairSAND(DObj_SpikyChairSAND other) : base(other)
		{
		...
		public override DObj_SpikyChairSAND Clone()
		{
			return new DObj_SpikyChairSAND(this);
		}
