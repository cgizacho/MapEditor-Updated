...
{
	public class Fld_Pillar03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Pillar03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Pillar03(Fld_Pillar03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Pillar03 Clone()
		{
			return new Fld_Pillar03(this);
		}
