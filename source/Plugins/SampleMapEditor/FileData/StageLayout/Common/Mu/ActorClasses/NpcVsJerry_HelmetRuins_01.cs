...
{
	public class NpcVsJerry_HelmetRuins_01 : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "NpcVsJerry_HelmetRuins_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "NpcVsJerry_HelmetRuins_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcVsJerry_HelmetRuins_01() : base()
		{
		...
		public NpcVsJerry_HelmetRuins_01(NpcVsJerry_HelmetRuins_01 other) : base(other)
		{
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override NpcVsJerry_HelmetRuins_01 Clone()
		{
			return new NpcVsJerry_HelmetRuins_01(this);
		}
