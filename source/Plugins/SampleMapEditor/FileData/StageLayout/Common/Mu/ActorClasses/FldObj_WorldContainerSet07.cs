...
{
	public class FldObj_WorldContainerSet07 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet07 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet07() : base()
		{
		...
		public FldObj_WorldContainerSet07(FldObj_WorldContainerSet07 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet07 Clone()
		{
			return new FldObj_WorldContainerSet07(this);
		}
