...
{
	public class Fld_Alterna4c02Decoration : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna4c02Decoration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna4c02Decoration() : base()
		{
		...
		public Fld_Alterna4c02Decoration(Fld_Alterna4c02Decoration other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna4c02Decoration Clone()
		{
			return new Fld_Alterna4c02Decoration(this);
		}
