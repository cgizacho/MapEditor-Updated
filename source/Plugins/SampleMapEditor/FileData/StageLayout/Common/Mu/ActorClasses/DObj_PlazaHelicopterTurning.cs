...
{
	public class DObj_PlazaHelicopterTurning : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaHelicopterTurning() : base()
		{
		...
		public DObj_PlazaHelicopterTurning(DObj_PlazaHelicopterTurning other) : base(other)
		{
		...
		public override DObj_PlazaHelicopterTurning Clone()
		{
			return new DObj_PlazaHelicopterTurning(this);
		}
