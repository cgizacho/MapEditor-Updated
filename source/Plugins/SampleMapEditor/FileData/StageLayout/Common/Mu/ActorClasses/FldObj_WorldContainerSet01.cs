...
{
	public class FldObj_WorldContainerSet01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet01() : base()
		{
		...
		public FldObj_WorldContainerSet01(FldObj_WorldContainerSet01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet01 Clone()
		{
			return new FldObj_WorldContainerSet01(this);
		}
