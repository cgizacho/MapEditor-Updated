...
{
	public class ItemCanInfinitySpecial_SuperHook : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanInfinitySpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanInfinitySpecial_SuperHook() : base()
		{
		...
		public ItemCanInfinitySpecial_SuperHook(ItemCanInfinitySpecial_SuperHook other) : base(other)
		{
		...
		public override ItemCanInfinitySpecial_SuperHook Clone()
		{
			return new ItemCanInfinitySpecial_SuperHook(this);
		}
