...
{
	public class Fld_Alterna4c03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna4c03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna4c03(Fld_Alterna4c03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna4c03 Clone()
		{
			return new Fld_Alterna4c03(this);
		}
