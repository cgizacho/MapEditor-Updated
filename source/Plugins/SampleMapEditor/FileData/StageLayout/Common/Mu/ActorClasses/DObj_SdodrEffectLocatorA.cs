...
{
	public class DObj_SdodrEffectLocatorA : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrEffectLocatorA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrEffectLocatorA() : base()
		{
		...
		public DObj_SdodrEffectLocatorA(DObj_SdodrEffectLocatorA other) : base(other)
		{
		...
		public override DObj_SdodrEffectLocatorA Clone()
		{
			return new DObj_SdodrEffectLocatorA(this);
		}
