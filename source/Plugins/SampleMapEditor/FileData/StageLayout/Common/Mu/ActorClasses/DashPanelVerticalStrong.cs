...
{
	public class DashPanelVerticalStrong : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "DashPanelVerticalStrong Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "DashPanelVerticalStrong Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DashPanelVerticalStrong() : base()
		{
		...
		public DashPanelVerticalStrong(DashPanelVerticalStrong other) : base(other)
		{
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override DashPanelVerticalStrong Clone()
		{
			return new DashPanelVerticalStrong(this);
		}
