...
{
	public class SighterTarget_Large : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_Large Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_Large() : base()
		{
		...
		public SighterTarget_Large(SighterTarget_Large other) : base(other)
		{
		...
		public override SighterTarget_Large Clone()
		{
			return new SighterTarget_Large(this);
		}
