...
{
	public class GfxPointLight_Inside : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Inside Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Inside() : base()
		{
		...
		public GfxPointLight_Inside(GfxPointLight_Inside other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Inside Clone()
		{
			return new GfxPointLight_Inside(this);
		}
