...
{
	public class Npc_JerryFest_AssistantDirector : MuObj
	{
		[BindGUI("AttCalcType", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "Npc_JerryFest_AssistantDirector Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_JerryFest_AssistantDirector() : base()
		{
		...
		public Npc_JerryFest_AssistantDirector(Npc_JerryFest_AssistantDirector other) : base(other)
		{
		...
		public override Npc_JerryFest_AssistantDirector Clone()
		{
			return new Npc_JerryFest_AssistantDirector(this);
		}
