...
{
	public class EnemyTakolienShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienShieldVehicle() : base()
		{
		...
		public EnemyTakolienShieldVehicle(EnemyTakolienShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienShieldVehicle Clone()
		{
			return new EnemyTakolienShieldVehicle(this);
		}
