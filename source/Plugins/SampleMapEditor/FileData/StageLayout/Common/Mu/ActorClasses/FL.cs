...
{
	public class FL : MuObj
	{
		[BindGUI("IsSpawnDirSpecified", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ColorGroupType", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OverwriteMaxHP", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementType", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRail", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		[BindGUI("ReserveNumTable", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "FL Properties", ColumnIndex = 0, Control = BindControl.Default)]
