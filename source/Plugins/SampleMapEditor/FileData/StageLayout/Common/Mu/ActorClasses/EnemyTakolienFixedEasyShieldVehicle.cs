...
{
	public class EnemyTakolienFixedEasyShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "EnemyTakolienFixedEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakolienFixedEasyShieldVehicle() : base()
		{
		...
		public EnemyTakolienFixedEasyShieldVehicle(EnemyTakolienFixedEasyShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienFixedEasyShieldVehicle Clone()
		{
			return new EnemyTakolienFixedEasyShieldVehicle(this);
		}
