...
{
	public class Fld_Shakespiral00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakespiral00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakespiral00(Fld_Shakespiral00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakespiral00 Clone()
		{
			return new Fld_Shakespiral00(this);
		}
