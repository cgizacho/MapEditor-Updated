...
{
	public class NpcPlazaJerry_SdodrSkateboard_01 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerry_SdodrSkateboard_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerry_SdodrSkateboard_01() : base()
		{
		...
		public NpcPlazaJerry_SdodrSkateboard_01(NpcPlazaJerry_SdodrSkateboard_01 other) : base(other)
		{
		...
		public override NpcPlazaJerry_SdodrSkateboard_01 Clone()
		{
			return new NpcPlazaJerry_SdodrSkateboard_01(this);
		}
