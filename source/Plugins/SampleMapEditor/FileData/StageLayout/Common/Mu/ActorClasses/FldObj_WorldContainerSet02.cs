...
{
	public class FldObj_WorldContainerSet02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet02() : base()
		{
		...
		public FldObj_WorldContainerSet02(FldObj_WorldContainerSet02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet02 Clone()
		{
			return new FldObj_WorldContainerSet02(this);
		}
