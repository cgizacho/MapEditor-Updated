...
{
	public class EnemyTakolienBounceVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienBounceVehicle() : base()
		{
		...
		public EnemyTakolienBounceVehicle(EnemyTakolienBounceVehicle other) : base(other)
		{
		...
		public override EnemyTakolienBounceVehicle Clone()
		{
			return new EnemyTakolienBounceVehicle(this);
		}
