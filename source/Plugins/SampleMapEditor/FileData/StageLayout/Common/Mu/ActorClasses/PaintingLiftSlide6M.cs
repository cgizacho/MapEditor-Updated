...
{
	public class PaintingLiftSlide6M : MuObj
	{
		[BindGUI("AttCalcType", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintRepeatFrame", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "PaintingLiftSlide6M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public PaintingLiftSlide6M() : base()
		{
		...
		public PaintingLiftSlide6M(PaintingLiftSlide6M other) : base(other)
		{
		...
		public override PaintingLiftSlide6M Clone()
		{
			return new PaintingLiftSlide6M(this);
		}
