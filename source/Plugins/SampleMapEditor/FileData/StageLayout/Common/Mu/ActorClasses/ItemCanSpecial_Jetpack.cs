...
{
	public class ItemCanSpecial_Jetpack : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_Jetpack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_Jetpack() : base()
		{
		...
		public ItemCanSpecial_Jetpack(ItemCanSpecial_Jetpack other) : base(other)
		{
		...
		public override ItemCanSpecial_Jetpack Clone()
		{
			return new ItemCanSpecial_Jetpack(this);
		}
