...
{
	public class DObj_FldObj_YagaraFloatDebrisA : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldObj_YagaraFloatDebrisA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldObj_YagaraFloatDebrisA() : base()
		{
		...
		public DObj_FldObj_YagaraFloatDebrisA(DObj_FldObj_YagaraFloatDebrisA other) : base(other)
		{
		...
		public override DObj_FldObj_YagaraFloatDebrisA Clone()
		{
			return new DObj_FldObj_YagaraFloatDebrisA(this);
		}
