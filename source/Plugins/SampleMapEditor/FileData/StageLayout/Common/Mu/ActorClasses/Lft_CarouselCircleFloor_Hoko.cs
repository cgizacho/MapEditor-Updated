...
{
	public class Lft_CarouselCircleFloor_Hoko : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_CarouselCircleFloor_Hoko Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_CarouselCircleFloor_Hoko Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_CarouselCircleFloor_Hoko Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_CarouselCircleFloor_Hoko Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_CarouselCircleFloor_Hoko Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_CarouselCircleFloor_Hoko() : base()
		{
		...
		public Lft_CarouselCircleFloor_Hoko(Lft_CarouselCircleFloor_Hoko other) : base(other)
		{
		...
		public override Lft_CarouselCircleFloor_Hoko Clone()
		{
			return new Lft_CarouselCircleFloor_Hoko(this);
		}
