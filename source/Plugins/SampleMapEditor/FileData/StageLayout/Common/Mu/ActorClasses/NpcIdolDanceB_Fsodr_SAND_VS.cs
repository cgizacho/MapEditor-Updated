...
{
	public class NpcIdolDanceB_Fsodr_SAND_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "NpcIdolDanceB_Fsodr_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("StageType", Category = "NpcIdolDanceB_Fsodr_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceB_Fsodr_SAND_VS() : base()
		{
		...
		public NpcIdolDanceB_Fsodr_SAND_VS(NpcIdolDanceB_Fsodr_SAND_VS other) : base(other)
		{
		...
		public override NpcIdolDanceB_Fsodr_SAND_VS Clone()
		{
			return new NpcIdolDanceB_Fsodr_SAND_VS(this);
		}
