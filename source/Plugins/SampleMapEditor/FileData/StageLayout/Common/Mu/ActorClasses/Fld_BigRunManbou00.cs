...
{
	public class Fld_BigRunManbou00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunManbou00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunManbou00() : base()
		{
		...
		public Fld_BigRunManbou00(Fld_BigRunManbou00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunManbou00 Clone()
		{
			return new Fld_BigRunManbou00(this);
		}
