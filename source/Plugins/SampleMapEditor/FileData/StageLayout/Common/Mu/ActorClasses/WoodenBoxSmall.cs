...
{
	public class WoodenBoxSmall : MuObj
	{
		[BindGUI("IsFreeY", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "WoodenBoxSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public WoodenBoxSmall(WoodenBoxSmall other) : base(other)
		{
		...
		public override WoodenBoxSmall Clone()
		{
			return new WoodenBoxSmall(this);
		}
