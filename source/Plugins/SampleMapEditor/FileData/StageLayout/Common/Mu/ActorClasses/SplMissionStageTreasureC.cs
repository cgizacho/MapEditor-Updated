...
{
	public class SplMissionStageTreasureC : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplMissionStageTreasureC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplMissionStageTreasureC() : base()
		{
		...
		public SplMissionStageTreasureC(SplMissionStageTreasureC other) : base(other)
		{
		...
		public override SplMissionStageTreasureC Clone()
		{
			return new SplMissionStageTreasureC(this);
		}
