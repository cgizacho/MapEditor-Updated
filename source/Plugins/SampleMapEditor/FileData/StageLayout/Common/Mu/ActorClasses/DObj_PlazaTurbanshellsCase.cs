...
{
	public class DObj_PlazaTurbanshellsCase : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaTurbanshellsCase Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaTurbanshellsCase() : base()
		{
		...
		public DObj_PlazaTurbanshellsCase(DObj_PlazaTurbanshellsCase other) : base(other)
		{
		...
		public override DObj_PlazaTurbanshellsCase Clone()
		{
			return new DObj_PlazaTurbanshellsCase(this);
		}
