...
{
	public class DObj_Collector_Sdodr : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Collector_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Collector_Sdodr() : base()
		{
		...
		public DObj_Collector_Sdodr(DObj_Collector_Sdodr other) : base(other)
		{
		...
		public override DObj_Collector_Sdodr Clone()
		{
			return new DObj_Collector_Sdodr(this);
		}
