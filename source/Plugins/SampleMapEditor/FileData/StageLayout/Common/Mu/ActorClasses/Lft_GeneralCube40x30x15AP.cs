...
{
	public class Lft_GeneralCube40x30x15AP : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_GeneralCube40x30x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_GeneralCube40x30x15AP() : base()
		{
		...
		public Lft_GeneralCube40x30x15AP(Lft_GeneralCube40x30x15AP other) : base(other)
		{
		...
		public override Lft_GeneralCube40x30x15AP Clone()
		{
			return new Lft_GeneralCube40x30x15AP(this);
		}
