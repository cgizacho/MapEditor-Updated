...
{
	public class GfxPointLight_Load_Blue : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Load_Blue Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Load_Blue() : base()
		{
		...
		public GfxPointLight_Load_Blue(GfxPointLight_Load_Blue other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Load_Blue Clone()
		{
			return new GfxPointLight_Load_Blue(this);
		}
