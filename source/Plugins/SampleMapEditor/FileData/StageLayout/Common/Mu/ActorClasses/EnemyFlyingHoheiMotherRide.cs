...
{
	public class EnemyFlyingHoheiMotherRide : MuObj
	{
		[BindGUI("ExtendFootholdDelaySec", Category = "EnemyFlyingHoheiMotherRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("LifeSpanSec", Category = "EnemyFlyingHoheiMotherRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyFlyingHoheiMotherRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyFlyingHoheiMotherRide() : base()
		{
		...
		public EnemyFlyingHoheiMotherRide(EnemyFlyingHoheiMotherRide other) : base(other)
		{
		...
		public override EnemyFlyingHoheiMotherRide Clone()
		{
			return new EnemyFlyingHoheiMotherRide(this);
		}
