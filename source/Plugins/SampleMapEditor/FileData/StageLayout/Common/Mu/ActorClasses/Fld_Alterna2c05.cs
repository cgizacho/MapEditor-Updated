...
{
	public class Fld_Alterna2c05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna2c05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna2c05(Fld_Alterna2c05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna2c05 Clone()
		{
			return new Fld_Alterna2c05(this);
		}
