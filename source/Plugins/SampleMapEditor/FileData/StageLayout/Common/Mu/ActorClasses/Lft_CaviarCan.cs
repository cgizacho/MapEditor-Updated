...
{
	public class Lft_CaviarCan : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_CaviarCan Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_CaviarCan Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_CaviarCan Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_CaviarCan Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_CaviarCan Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_CaviarCan(Lft_CaviarCan other) : base(other)
		{
		...
		public override Lft_CaviarCan Clone()
		{
			return new Lft_CaviarCan(this);
		}
