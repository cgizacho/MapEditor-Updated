...
{
	public class DObj_SdodrPlazaHelicopterHovering : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrPlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrPlazaHelicopterHovering() : base()
		{
		...
		public DObj_SdodrPlazaHelicopterHovering(DObj_SdodrPlazaHelicopterHovering other) : base(other)
		{
		...
		public override DObj_SdodrPlazaHelicopterHovering Clone()
		{
			return new DObj_SdodrPlazaHelicopterHovering(this);
		}
