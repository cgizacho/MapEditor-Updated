...
{
	public class Fld_Jyoheki03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Jyoheki03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Jyoheki03(Fld_Jyoheki03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Jyoheki03 Clone()
		{
			return new Fld_Jyoheki03(this);
		}
