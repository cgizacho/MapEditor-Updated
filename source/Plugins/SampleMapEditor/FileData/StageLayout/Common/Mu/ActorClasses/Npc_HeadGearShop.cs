...
namespace SampleMapEditor
{
	public class Npc_HeadGearShop : MuObj
	{
		...
		public Npc_HeadGearShop(Npc_HeadGearShop other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override Npc_HeadGearShop Clone()
		{
			return new Npc_HeadGearShop(this);
		}
