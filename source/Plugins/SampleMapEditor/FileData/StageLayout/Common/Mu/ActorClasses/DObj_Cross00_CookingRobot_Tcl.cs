...
{
	public class DObj_Cross00_CookingRobot_Tcl : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Cross00_CookingRobot_Tcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Cross00_CookingRobot_Tcl() : base()
		{
		...
		public DObj_Cross00_CookingRobot_Tcl(DObj_Cross00_CookingRobot_Tcl other) : base(other)
		{
		...
		public override DObj_Cross00_CookingRobot_Tcl Clone()
		{
			return new DObj_Cross00_CookingRobot_Tcl(this);
		}
