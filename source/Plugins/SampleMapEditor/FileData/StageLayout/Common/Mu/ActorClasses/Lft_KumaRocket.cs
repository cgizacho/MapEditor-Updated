...
{
	public class Lft_KumaRocket : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_KumaRocket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_KumaRocket(Lft_KumaRocket other) : base(other)
		{
		...
		public override Lft_KumaRocket Clone()
		{
			return new Lft_KumaRocket(this);
		}
