...
namespace SampleMapEditor
{
	public class Obj_MsnWallaCylinder10x10x10 : MuObj
	{
		...
		public Obj_MsnWallaCylinder10x10x10(Obj_MsnWallaCylinder10x10x10 other) : base(other)
		{
			spl__WallaObjBancParam = other.spl__WallaObjBancParam.Clone();
		}

		public override Obj_MsnWallaCylinder10x10x10 Clone()
		{
			return new Obj_MsnWallaCylinder10x10x10(this);
		}
