...
{
	public class Fld_AlternaR02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaR02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaR02(Fld_AlternaR02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaR02 Clone()
		{
			return new Fld_AlternaR02(this);
		}
