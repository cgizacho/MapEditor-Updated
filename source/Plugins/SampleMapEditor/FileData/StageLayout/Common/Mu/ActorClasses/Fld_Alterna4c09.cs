...
{
	public class Fld_Alterna4c09 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna4c09 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna4c09(Fld_Alterna4c09 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna4c09 Clone()
		{
			return new Fld_Alterna4c09(this);
		}
