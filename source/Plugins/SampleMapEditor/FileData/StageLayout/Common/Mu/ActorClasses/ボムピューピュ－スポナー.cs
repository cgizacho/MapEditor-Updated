...
{
	public class ボムピューピュ_スポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "ボムピューピュ－スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ボムピューピュ_スポナー(ボムピューピュ_スポナー other) : base(other)
		{
		...
		public override ボムピューピュ_スポナー Clone()
		{
			return new ボムピューピュ_スポナー(this);
		}
