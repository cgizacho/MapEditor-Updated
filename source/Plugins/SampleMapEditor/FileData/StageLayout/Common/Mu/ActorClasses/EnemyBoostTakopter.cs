...
{
	public class EnemyBoostTakopter : MuObj
	{
		[BindGUI("IsFixedMode", Category = "EnemyBoostTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyBoostTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyBoostTakopter() : base()
		{
		...
		public EnemyBoostTakopter(EnemyBoostTakopter other) : base(other)
		{
		...
		public override EnemyBoostTakopter Clone()
		{
			return new EnemyBoostTakopter(this);
		}
