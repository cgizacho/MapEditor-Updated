...
{
	public class Lft_FldObj_AutoWalk00LiftIntRightA : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftIntRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftIntRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftIntRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftIntRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftIntRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftIntRightA() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftIntRightA(Lft_FldObj_AutoWalk00LiftIntRightA other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftIntRightA Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftIntRightA(this);
		}
