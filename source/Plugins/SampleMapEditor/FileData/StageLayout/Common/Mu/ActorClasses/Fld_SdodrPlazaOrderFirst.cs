...
{
	public class Fld_SdodrPlazaOrderFirst : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Fld_SdodrPlazaOrderFirst Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Fld_SdodrPlazaOrderFirst Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "Fld_SdodrPlazaOrderFirst Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "Fld_SdodrPlazaOrderFirst Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrPlazaOrderFirst() : base()
		{
		...
		public Fld_SdodrPlazaOrderFirst(Fld_SdodrPlazaOrderFirst other) : base(other)
		{
		...
		public override Fld_SdodrPlazaOrderFirst Clone()
		{
			return new Fld_SdodrPlazaOrderFirst(this);
		}
