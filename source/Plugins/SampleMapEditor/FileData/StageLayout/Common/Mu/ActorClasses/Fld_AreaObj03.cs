...
{
	public class Fld_AreaObj03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj03(Fld_AreaObj03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj03 Clone()
		{
			return new Fld_AreaObj03(this);
		}
