...
{
	public class DObj_SeaBind_BuoyBurner : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SeaBind_BuoyBurner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SeaBind_BuoyBurner() : base()
		{
		...
		public DObj_SeaBind_BuoyBurner(DObj_SeaBind_BuoyBurner other) : base(other)
		{
		...
		public override DObj_SeaBind_BuoyBurner Clone()
		{
			return new DObj_SeaBind_BuoyBurner(this);
		}
