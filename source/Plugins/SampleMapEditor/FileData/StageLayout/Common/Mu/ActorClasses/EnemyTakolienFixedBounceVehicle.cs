...
{
	public class EnemyTakolienFixedBounceVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "EnemyTakolienFixedBounceVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakolienFixedBounceVehicle() : base()
		{
		...
		public EnemyTakolienFixedBounceVehicle(EnemyTakolienFixedBounceVehicle other) : base(other)
		{
		...
		public override EnemyTakolienFixedBounceVehicle Clone()
		{
			return new EnemyTakolienFixedBounceVehicle(this);
		}
