...
{
	public class ノコノコスポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "ノコノコスポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ノコノコスポナー(ノコノコスポナー other) : base(other)
		{
		...
		public override ノコノコスポナー Clone()
		{
			return new ノコノコスポナー(this);
		}
