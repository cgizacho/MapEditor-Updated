...
{
	public class DObj_AutoWalk00_BankaraTrain : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_AutoWalk00_BankaraTrain Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_AutoWalk00_BankaraTrain() : base()
		{
		...
		public DObj_AutoWalk00_BankaraTrain(DObj_AutoWalk00_BankaraTrain other) : base(other)
		{
		...
		public override DObj_AutoWalk00_BankaraTrain Clone()
		{
			return new DObj_AutoWalk00_BankaraTrain(this);
		}
