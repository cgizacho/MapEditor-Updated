...
{
	public class SighterTarget_TipsTrialMove : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_TipsTrialMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_TipsTrialMove() : base()
		{
		...
		public SighterTarget_TipsTrialMove(SighterTarget_TipsTrialMove other) : base(other)
		{
		...
		public override SighterTarget_TipsTrialMove Clone()
		{
			return new SighterTarget_TipsTrialMove(this);
		}
