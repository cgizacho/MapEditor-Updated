...
{
	public class DObj_TutorialGiftBox : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_TutorialGiftBox Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_TutorialGiftBox() : base()
		{
		...
		public DObj_TutorialGiftBox(DObj_TutorialGiftBox other) : base(other)
		{
		...
		public override DObj_TutorialGiftBox Clone()
		{
			return new DObj_TutorialGiftBox(this);
		}
