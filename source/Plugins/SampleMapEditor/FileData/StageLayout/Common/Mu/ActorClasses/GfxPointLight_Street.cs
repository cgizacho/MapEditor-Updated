...
{
	public class GfxPointLight_Street : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Street Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Street Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Street Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Street Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Street Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Street() : base()
		{
		...
		public GfxPointLight_Street(GfxPointLight_Street other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Street Clone()
		{
			return new GfxPointLight_Street(this);
		}
