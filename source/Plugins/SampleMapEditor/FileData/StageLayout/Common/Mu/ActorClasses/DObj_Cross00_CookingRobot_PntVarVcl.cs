...
{
	public class DObj_Cross00_CookingRobot_PntVarVcl : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Cross00_CookingRobot_PntVarVcl Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Cross00_CookingRobot_PntVarVcl() : base()
		{
		...
		public DObj_Cross00_CookingRobot_PntVarVcl(DObj_Cross00_CookingRobot_PntVarVcl other) : base(other)
		{
		...
		public override DObj_Cross00_CookingRobot_PntVarVcl Clone()
		{
			return new DObj_Cross00_CookingRobot_PntVarVcl(this);
		}
