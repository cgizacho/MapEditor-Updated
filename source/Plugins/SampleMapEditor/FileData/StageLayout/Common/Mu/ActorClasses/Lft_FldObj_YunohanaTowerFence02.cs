...
{
	public class Lft_FldObj_YunohanaTowerFence02 : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_YunohanaTowerFence02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_YunohanaTowerFence02() : base()
		{
		...
		public Lft_FldObj_YunohanaTowerFence02(Lft_FldObj_YunohanaTowerFence02 other) : base(other)
		{
		...
		public override Lft_FldObj_YunohanaTowerFence02 Clone()
		{
			return new Lft_FldObj_YunohanaTowerFence02(this);
		}
