...
{
	public class DemoLightA : MuObj
	{
		[BindGUI("AngleDamp", Category = "DemoLightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "DemoLightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DistDamp", Category = "DemoLightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "DemoLightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "DemoLightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DemoLightA(DemoLightA other) : base(other)
		{
			spl__gfx__LocatorSpotLightBancParam = other.spl__gfx__LocatorSpotLightBancParam.Clone();
		}

		public override DemoLightA Clone()
		{
			return new DemoLightA(this);
		}
