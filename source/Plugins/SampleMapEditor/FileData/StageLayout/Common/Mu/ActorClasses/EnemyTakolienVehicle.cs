...
{
	public class EnemyTakolienVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienVehicle() : base()
		{
		...
		public EnemyTakolienVehicle(EnemyTakolienVehicle other) : base(other)
		{
		...
		public override EnemyTakolienVehicle Clone()
		{
			return new EnemyTakolienVehicle(this);
		}
