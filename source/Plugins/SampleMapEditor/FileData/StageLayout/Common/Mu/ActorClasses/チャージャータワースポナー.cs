...
{
	public class チャージャータワースポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "チャージャータワースポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public チャージャータワースポナー(チャージャータワースポナー other) : base(other)
		{
		...
		public override チャージャータワースポナー Clone()
		{
			return new チャージャータワースポナー(this);
		}
