...
{
	public class Fld_AlternaR03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaR03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaR03(Fld_AlternaR03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaR03 Clone()
		{
			return new Fld_AlternaR03(this);
		}
