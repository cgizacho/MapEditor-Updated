...
{
	public class Npc_Mizuta_SAND_CStage : MuObj
	{
		[BindGUI("AttCalcType", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "Npc_Mizuta_SAND_CStage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_Mizuta_SAND_CStage() : base()
		{
		...
		public Npc_Mizuta_SAND_CStage(Npc_Mizuta_SAND_CStage other) : base(other)
		{
		...
		public override Npc_Mizuta_SAND_CStage Clone()
		{
			return new Npc_Mizuta_SAND_CStage(this);
		}
