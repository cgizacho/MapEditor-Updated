...
namespace SampleMapEditor
{
	public class DObj_PlazaJerry_Zakka01_Fsodr : MuObj
	{
		...
		public DObj_PlazaJerry_Zakka01_Fsodr(DObj_PlazaJerry_Zakka01_Fsodr other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override DObj_PlazaJerry_Zakka01_Fsodr Clone()
		{
			return new DObj_PlazaJerry_Zakka01_Fsodr(this);
		}
