...
{
	public class DObj_SdodrEffectLocatorE : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrEffectLocatorE Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrEffectLocatorE() : base()
		{
		...
		public DObj_SdodrEffectLocatorE(DObj_SdodrEffectLocatorE other) : base(other)
		{
		...
		public override DObj_SdodrEffectLocatorE Clone()
		{
			return new DObj_SdodrEffectLocatorE(this);
		}
