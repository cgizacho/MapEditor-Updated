...
{
	public class DObj_Prop_PaperWallTower : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Prop_PaperWallTower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Prop_PaperWallTower() : base()
		{
		...
		public DObj_Prop_PaperWallTower(DObj_Prop_PaperWallTower other) : base(other)
		{
		...
		public override DObj_Prop_PaperWallTower Clone()
		{
			return new DObj_Prop_PaperWallTower(this);
		}
