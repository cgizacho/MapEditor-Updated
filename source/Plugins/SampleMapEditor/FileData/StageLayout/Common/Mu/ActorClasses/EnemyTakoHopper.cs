...
{
	public class EnemyTakoHopper : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakoHopper Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakoHopper Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakoHopper Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakoHopper Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakoHopper(EnemyTakoHopper other) : base(other)
		{
		...
		public override EnemyTakoHopper Clone()
		{
			return new EnemyTakoHopper(this);
		}
