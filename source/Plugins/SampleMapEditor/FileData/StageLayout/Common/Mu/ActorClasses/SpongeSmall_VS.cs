...
{
	public class SpongeSmall_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "SpongeSmall_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "SpongeSmall_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		public SpongeSmall_VS(SpongeSmall_VS other) : base(other)
		{
		...
		public override SpongeSmall_VS Clone()
		{
			return new SpongeSmall_VS(this);
		}
