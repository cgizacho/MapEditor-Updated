...
{
	public class NpcVsJerry_Float_04 : MuObj
	{
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_Float_04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_Float_04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		public NpcVsJerry_Float_04() : base()
		{
		...
		public NpcVsJerry_Float_04(NpcVsJerry_Float_04 other) : base(other)
		{
			spl__OceanBindableHelperBancParam = other.spl__OceanBindableHelperBancParam.Clone();
		}

		public override NpcVsJerry_Float_04 Clone()
		{
			return new NpcVsJerry_Float_04(this);
		}
