...
{
	public class PropellerUp : MuObj
	{
		[BindGUI("ImpulseOnDamage", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveAcc", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnAcc", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnSpeedMax", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeedMax", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "PropellerUp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public PropellerUp(PropellerUp other) : base(other)
		{
		...
		public override PropellerUp Clone()
		{
			return new PropellerUp(this);
		}
