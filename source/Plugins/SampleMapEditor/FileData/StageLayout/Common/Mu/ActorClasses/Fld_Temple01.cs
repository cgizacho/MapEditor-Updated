...
{
	public class Fld_Temple01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Temple01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Temple01(Fld_Temple01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Temple01 Clone()
		{
			return new Fld_Temple01(this);
		}
