...
{
	public class Fld_BigRunDistrict00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunDistrict00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunDistrict00() : base()
		{
		...
		public Fld_BigRunDistrict00(Fld_BigRunDistrict00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunDistrict00 Clone()
		{
			return new Fld_BigRunDistrict00(this);
		}
