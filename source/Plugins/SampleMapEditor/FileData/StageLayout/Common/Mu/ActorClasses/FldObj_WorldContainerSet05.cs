...
{
	public class FldObj_WorldContainerSet05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet05() : base()
		{
		...
		public FldObj_WorldContainerSet05(FldObj_WorldContainerSet05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet05 Clone()
		{
			return new FldObj_WorldContainerSet05(this);
		}
