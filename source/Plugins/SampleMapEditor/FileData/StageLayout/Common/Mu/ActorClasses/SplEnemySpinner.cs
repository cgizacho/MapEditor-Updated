...
{
	public class SplEnemySpinner : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplEnemySpinner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplEnemySpinner Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[ByamlMember("spl__EnemySpinnerBancParam")]
		public Mu_spl__EnemySpinnerBancParam spl__EnemySpinnerBancParam { get; set; }
		...
		public SplEnemySpinner() : base()
		{
			spl__AttentionTargetingBancParam = new Mu_spl__AttentionTargetingBancParam();
			spl__EnemySpinnerBancParam = new Mu_spl__EnemySpinnerBancParam();
		...
		public SplEnemySpinner(SplEnemySpinner other) : base(other)
		{
			spl__AttentionTargetingBancParam = other.spl__AttentionTargetingBancParam.Clone();
			spl__EnemySpinnerBancParam = other.spl__EnemySpinnerBancParam.Clone();
		...
		public override SplEnemySpinner Clone()
		{
			return new SplEnemySpinner(this);
		}

		public override void SaveAdditionalParameters(BymlNode.DictionaryNode SerializedActor)
		{
			this.spl__AttentionTargetingBancParam.SaveParameterBank(SerializedActor);
			this.spl__EnemySpinnerBancParam.SaveParameterBank(SerializedActor);
