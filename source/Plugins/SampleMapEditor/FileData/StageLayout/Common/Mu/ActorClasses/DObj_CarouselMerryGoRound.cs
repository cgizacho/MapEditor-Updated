...
{
	public class DObj_CarouselMerryGoRound : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_CarouselMerryGoRound Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_CarouselMerryGoRound() : base()
		{
		...
		public DObj_CarouselMerryGoRound(DObj_CarouselMerryGoRound other) : base(other)
		{
		...
		public override DObj_CarouselMerryGoRound Clone()
		{
			return new DObj_CarouselMerryGoRound(this);
		}
