...
{
	public class AirBall_IgnoreCulling : MuObj
	{
		[BindGUI("AttCalcType", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "AirBall_IgnoreCulling Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public AirBall_IgnoreCulling() : base()
		{
		...
		public AirBall_IgnoreCulling(AirBall_IgnoreCulling other) : base(other)
		{
		...
		public override AirBall_IgnoreCulling Clone()
		{
			return new AirBall_IgnoreCulling(this);
		}
