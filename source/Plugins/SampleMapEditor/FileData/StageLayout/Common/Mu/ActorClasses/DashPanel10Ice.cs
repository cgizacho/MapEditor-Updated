...
{
	public class DashPanel10Ice : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "DashPanel10Ice Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "DashPanel10Ice Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DashPanel10Ice(DashPanel10Ice other) : base(other)
		{
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override DashPanel10Ice Clone()
		{
			return new DashPanel10Ice(this);
		}
