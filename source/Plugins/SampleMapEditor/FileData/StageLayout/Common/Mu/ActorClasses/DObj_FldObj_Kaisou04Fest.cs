...
{
	public class DObj_FldObj_Kaisou04Fest : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldObj_Kaisou04Fest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldObj_Kaisou04Fest() : base()
		{
		...
		public DObj_FldObj_Kaisou04Fest(DObj_FldObj_Kaisou04Fest other) : base(other)
		{
		...
		public override DObj_FldObj_Kaisou04Fest Clone()
		{
			return new DObj_FldObj_Kaisou04Fest(this);
		}
