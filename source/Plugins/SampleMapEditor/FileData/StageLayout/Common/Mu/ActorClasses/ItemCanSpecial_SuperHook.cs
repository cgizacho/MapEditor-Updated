...
{
	public class ItemCanSpecial_SuperHook : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_SuperHook Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_SuperHook() : base()
		{
		...
		public ItemCanSpecial_SuperHook(ItemCanSpecial_SuperHook other) : base(other)
		{
		...
		public override ItemCanSpecial_SuperHook Clone()
		{
			return new ItemCanSpecial_SuperHook(this);
		}
