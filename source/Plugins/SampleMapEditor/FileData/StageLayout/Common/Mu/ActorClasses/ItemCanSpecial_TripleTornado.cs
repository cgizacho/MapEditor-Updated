...
{
	public class ItemCanSpecial_TripleTornado : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_TripleTornado Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_TripleTornado() : base()
		{
		...
		public ItemCanSpecial_TripleTornado(ItemCanSpecial_TripleTornado other) : base(other)
		{
		...
		public override ItemCanSpecial_TripleTornado Clone()
		{
			return new ItemCanSpecial_TripleTornado(this);
		}
