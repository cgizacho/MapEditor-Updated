...
{
	public class Lft_AbstractBlitzCompatibles : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
        ...
        [BindGUI("PatrolType",
            new object[2] { "", "cContinue" },
            new string[2] { "Stop", "Continue" },
            Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.ComboBox)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Wait Time Rail", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Wait Time Rotate", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_AbstractBlitzCompatibles Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_AbstractBlitzCompatibles() : base()
		{
		...
		public Lft_AbstractBlitzCompatibles(Lft_AbstractBlitzCompatibles other) : base(other)
		{
		...
		public override Lft_AbstractBlitzCompatibles Clone()
		{
			return new Lft_AbstractBlitzCompatibles(this);
		}
