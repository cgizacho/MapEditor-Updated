...
{
	public class Gachiyagura_3M : MuObj
	{
		[BindGUI("ToRailPoint", Category = "Gachiyagura_3M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Gachiyagura_3M(Gachiyagura_3M other) : base(other)
		{
			spl__GachiyaguraBancParam = other.spl__GachiyaguraBancParam.Clone();
		}

		public override Gachiyagura_3M Clone()
		{
			return new Gachiyagura_3M(this);
		}
