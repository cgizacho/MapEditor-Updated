...
{
	public class Lft_AbstractTwoPoint : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Accel", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Accel
		{
			get
			{
		...
		[BindGUI("Decel", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Decel
		{
			get
			{
		...
		[BindGUI("MaxSpeed", Category = "Lft_AbstractTwoPoint Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_AbstractTwoPoint() : base()
		{
		...
		public Lft_AbstractTwoPoint(Lft_AbstractTwoPoint other) : base(other)
		{
		...
		public override Lft_AbstractTwoPoint Clone()
		{
			return new Lft_AbstractTwoPoint(this);
		}
