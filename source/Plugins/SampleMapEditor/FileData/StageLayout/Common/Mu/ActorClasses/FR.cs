...
{
	public class FR : MuObj
	{
		[BindGUI("IsSpawnDirSpecified", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ColorGroupType", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OverwriteMaxHP", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementType", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRail", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		[BindGUI("ReserveNumTable", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "FR Properties", ColumnIndex = 0, Control = BindControl.Default)]
