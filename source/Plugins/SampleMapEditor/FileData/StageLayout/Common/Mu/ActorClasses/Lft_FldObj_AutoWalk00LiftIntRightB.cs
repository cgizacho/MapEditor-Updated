...
{
	public class Lft_FldObj_AutoWalk00LiftIntRightB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftIntRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftIntRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftIntRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftIntRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftIntRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftIntRightB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftIntRightB(Lft_FldObj_AutoWalk00LiftIntRightB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftIntRightB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftIntRightB(this);
		}
