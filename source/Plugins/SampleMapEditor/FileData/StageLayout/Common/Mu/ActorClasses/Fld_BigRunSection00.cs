...
{
	public class Fld_BigRunSection00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunSection00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunSection00() : base()
		{
		...
		public Fld_BigRunSection00(Fld_BigRunSection00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunSection00 Clone()
		{
			return new Fld_BigRunSection00(this);
		}
