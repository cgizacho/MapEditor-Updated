...
{
	public class NpcIdolDanceA_SAND_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "NpcIdolDanceA_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("StageType", Category = "NpcIdolDanceA_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceA_SAND_VS() : base()
		{
		...
		public NpcIdolDanceA_SAND_VS(NpcIdolDanceA_SAND_VS other) : base(other)
		{
		...
		public override NpcIdolDanceA_SAND_VS Clone()
		{
			return new NpcIdolDanceA_SAND_VS(this);
		}
