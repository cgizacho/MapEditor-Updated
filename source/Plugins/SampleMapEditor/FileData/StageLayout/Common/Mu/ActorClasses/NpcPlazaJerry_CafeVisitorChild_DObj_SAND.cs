...
{
	public class NpcPlazaJerry_CafeVisitorChild_DObj_SAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerry_CafeVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerry_CafeVisitorChild_DObj_SAND() : base()
		{
		...
		public NpcPlazaJerry_CafeVisitorChild_DObj_SAND(NpcPlazaJerry_CafeVisitorChild_DObj_SAND other) : base(other)
		{
		...
		public override NpcPlazaJerry_CafeVisitorChild_DObj_SAND Clone()
		{
			return new NpcPlazaJerry_CafeVisitorChild_DObj_SAND(this);
		}
