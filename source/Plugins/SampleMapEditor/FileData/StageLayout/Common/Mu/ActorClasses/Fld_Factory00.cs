...
{
	public class Fld_Factory00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Factory00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Factory00(Fld_Factory00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Factory00 Clone()
		{
			return new Fld_Factory00(this);
		}
