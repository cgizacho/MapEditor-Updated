...
{
	public class DObj_BunkerTowerKingSdodr : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_BunkerTowerKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_BunkerTowerKingSdodr() : base()
		{
		...
		public DObj_BunkerTowerKingSdodr(DObj_BunkerTowerKingSdodr other) : base(other)
		{
		...
		public override DObj_BunkerTowerKingSdodr Clone()
		{
			return new DObj_BunkerTowerKingSdodr(this);
		}
