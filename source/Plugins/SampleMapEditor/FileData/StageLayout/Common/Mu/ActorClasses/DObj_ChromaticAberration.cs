...
{
	public class DObj_ChromaticAberration : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_ChromaticAberration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_ChromaticAberration() : base()
		{
		...
		public DObj_ChromaticAberration(DObj_ChromaticAberration other) : base(other)
		{
		...
		public override DObj_ChromaticAberration Clone()
		{
			return new DObj_ChromaticAberration(this);
		}
