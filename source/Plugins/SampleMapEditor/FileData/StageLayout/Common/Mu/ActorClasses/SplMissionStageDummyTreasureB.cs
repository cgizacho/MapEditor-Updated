...
{
	public class SplMissionStageDummyTreasureB : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplMissionStageDummyTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplMissionStageDummyTreasureB() : base()
		{
		...
		public SplMissionStageDummyTreasureB(SplMissionStageDummyTreasureB other) : base(other)
		{
		...
		public override SplMissionStageDummyTreasureB Clone()
		{
			return new SplMissionStageDummyTreasureB(this);
		}
