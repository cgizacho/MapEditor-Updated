...
{
	public class Fld_ShootingRange : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_ShootingRange Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_ShootingRange(Fld_ShootingRange other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_ShootingRange Clone()
		{
			return new Fld_ShootingRange(this);
		}
