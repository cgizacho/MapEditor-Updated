...
{
	public class ItemIkuraBottle : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DropIkuraValue", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public int _DropIkuraValue
		{
			get
			{
				return this.spl__ItemIkuraBottleBancParam.DropIkuraValue;
			}

			set
			{
				this.spl__ItemIkuraBottleBancParam.DropIkuraValue = value;
			}
		}

		[BindGUI("DropNum", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public int _DropNum
		{
			get
			{
				return this.spl__ItemIkuraBottleBancParam.DropNum;
			}

			set
			{
				this.spl__ItemIkuraBottleBancParam.DropNum = value;
			}
		}

		[BindGUI("PlacementID", Category = "ItemIkuraBottle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[ByamlMember("spl__ItemIkuraBottleBancParam")]
		public Mu_spl__ItemIkuraBottleBancParam spl__ItemIkuraBottleBancParam { get; set; }
		...
		public ItemIkuraBottle() : base()
		{
			...
			spl__ItemIkuraBottleBancParam = new Mu_spl__ItemIkuraBottleBancParam();
			spl__ItemWithPedestalBancParam = new Mu_spl__ItemWithPedestalBancParam();

			Links = new List<Link>();
		}

		public ItemIkuraBottle(ItemIkuraBottle other) : base(other)
		{
			...
			spl__ItemIkuraBottleBancParam = other.spl__ItemIkuraBottleBancParam.Clone();
			spl__ItemWithPedestalBancParam = other.spl__ItemWithPedestalBancParam.Clone();
		}

		public override ItemIkuraBottle Clone()
		{
			return new ItemIkuraBottle(this);
		}
		...
		public override void SaveAdditionalParameters(BymlNode.DictionaryNode SerializedActor)
		{
			...
			this.spl__ItemIkuraBottleBancParam.SaveParameterBank(SerializedActor);
