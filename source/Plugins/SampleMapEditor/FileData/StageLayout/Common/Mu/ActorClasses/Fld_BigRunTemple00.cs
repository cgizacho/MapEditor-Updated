...
{
	public class Fld_BigRunTemple00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunTemple00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunTemple00() : base()
		{
		...
		public Fld_BigRunTemple00(Fld_BigRunTemple00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunTemple00 Clone()
		{
			return new Fld_BigRunTemple00(this);
		}
