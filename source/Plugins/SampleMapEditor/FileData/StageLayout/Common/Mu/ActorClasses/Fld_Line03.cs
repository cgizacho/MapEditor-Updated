...
{
	public class Fld_Line03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Line03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Line03(Fld_Line03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Line03 Clone()
		{
			return new Fld_Line03(this);
		}
