...
{
	public class Lft_CarouselCircleFloorMove : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_CarouselCircleFloorMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_CarouselCircleFloorMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_CarouselCircleFloorMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_CarouselCircleFloorMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_CarouselCircleFloorMove Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_CarouselCircleFloorMove() : base()
		{
		...
		public Lft_CarouselCircleFloorMove(Lft_CarouselCircleFloorMove other) : base(other)
		{
		...
		public override Lft_CarouselCircleFloorMove Clone()
		{
			return new Lft_CarouselCircleFloorMove(this);
		}
