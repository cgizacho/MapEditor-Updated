...
{
	public class Lft_AbstractBlitzCompatibleSpectacle : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_AbstractBlitzCompatibleSpectacle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_AbstractBlitzCompatibleSpectacle() : base()
		{
		...
		public Lft_AbstractBlitzCompatibleSpectacle(Lft_AbstractBlitzCompatibleSpectacle other) : base(other)
		{
		...
		public override Lft_AbstractBlitzCompatibleSpectacle Clone()
		{
			return new Lft_AbstractBlitzCompatibleSpectacle(this);
		}
