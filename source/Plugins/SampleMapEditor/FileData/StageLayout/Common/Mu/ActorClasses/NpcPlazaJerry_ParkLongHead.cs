...
{
	public class NpcPlazaJerry_ParkLongHead : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerry_ParkLongHead Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerry_ParkLongHead() : base()
		{
		...
		public NpcPlazaJerry_ParkLongHead(NpcPlazaJerry_ParkLongHead other) : base(other)
		{
		...
		public override NpcPlazaJerry_ParkLongHead Clone()
		{
			return new NpcPlazaJerry_ParkLongHead(this);
		}
