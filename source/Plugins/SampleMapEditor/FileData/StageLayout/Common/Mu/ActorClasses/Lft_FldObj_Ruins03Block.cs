...
{
	public class Lft_FldObj_Ruins03Block : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Accel", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Accel
		{
			get
			{
		...
		[BindGUI("Decel", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Decel
		{
			get
			{
		...
		[BindGUI("MaxSpeed", Category = "Lft_FldObj_Ruins03Block Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_Ruins03Block() : base()
		{
		...
		public Lft_FldObj_Ruins03Block(Lft_FldObj_Ruins03Block other) : base(other)
		{
		...
		public override Lft_FldObj_Ruins03Block Clone()
		{
			return new Lft_FldObj_Ruins03Block(this);
		}
