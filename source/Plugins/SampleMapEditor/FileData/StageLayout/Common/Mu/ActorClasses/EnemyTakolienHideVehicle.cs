...
{
	public class EnemyTakolienHideVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienHideVehicle() : base()
		{
		...
		public EnemyTakolienHideVehicle(EnemyTakolienHideVehicle other) : base(other)
		{
		...
		public override EnemyTakolienHideVehicle Clone()
		{
			return new EnemyTakolienHideVehicle(this);
		}
