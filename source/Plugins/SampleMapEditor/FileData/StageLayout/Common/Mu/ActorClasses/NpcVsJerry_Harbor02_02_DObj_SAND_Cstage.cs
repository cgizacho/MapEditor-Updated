...
{
	public class NpcVsJerry_Harbor02_02_DObj_SAND_Cstage : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcVsJerry_Harbor02_02_DObj_SAND_Cstage() : base()
		{
		...
		public NpcVsJerry_Harbor02_02_DObj_SAND_Cstage(NpcVsJerry_Harbor02_02_DObj_SAND_Cstage other) : base(other)
		{
		...
		public override NpcVsJerry_Harbor02_02_DObj_SAND_Cstage Clone()
		{
			return new NpcVsJerry_Harbor02_02_DObj_SAND_Cstage(this);
		}
