...
namespace SampleMapEditor
{
	public class Obj_YagaraBox02 : MuObj
	{
		...
		public Obj_YagaraBox02(Obj_YagaraBox02 other) : base(other)
		{
			spl__WallaObjBancParam = other.spl__WallaObjBancParam.Clone();
		}

		public override Obj_YagaraBox02 Clone()
		{
			return new Obj_YagaraBox02(this);
		}
