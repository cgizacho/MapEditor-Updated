...
{
	public class ItemCanSpecial_InkStorm : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_InkStorm Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_InkStorm() : base()
		{
		...
		public ItemCanSpecial_InkStorm(ItemCanSpecial_InkStorm other) : base(other)
		{
		...
		public override ItemCanSpecial_InkStorm Clone()
		{
			return new ItemCanSpecial_InkStorm(this);
		}
