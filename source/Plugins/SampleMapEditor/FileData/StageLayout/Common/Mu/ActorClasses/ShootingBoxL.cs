...
{
	public class ShootingBoxL : MuObj
	{
		[BindGUI("IsFreeY", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "ShootingBoxL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ShootingBoxL(ShootingBoxL other) : base(other)
		{
		...
		public override ShootingBoxL Clone()
		{
			return new ShootingBoxL(this);
		}
