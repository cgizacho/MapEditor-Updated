...
{
	public class Lft_FldObj_AutoWalk00LiftCenterB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftCenterB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftCenterB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftCenterB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftCenterB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftCenterB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftCenterB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftCenterB(Lft_FldObj_AutoWalk00LiftCenterB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftCenterB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftCenterB(this);
		}
