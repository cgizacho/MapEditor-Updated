...
{
	public class UtuboLight : MuObj
	{
		[BindGUI("AngleDamp", Category = "UtuboLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "UtuboLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DistDamp", Category = "UtuboLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "UtuboLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "UtuboLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public UtuboLight(UtuboLight other) : base(other)
		{
			spl__gfx__LocatorSpotLightBancParam = other.spl__gfx__LocatorSpotLightBancParam.Clone();
		}

		public override UtuboLight Clone()
		{
			return new UtuboLight(this);
		}
