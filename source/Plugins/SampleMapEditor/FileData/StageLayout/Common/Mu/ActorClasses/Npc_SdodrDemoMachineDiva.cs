...
{
	public class Npc_SdodrDemoMachineDiva : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsInitEventVisible", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematicWait", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsTakeOverVisible", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitASCommand", Category = "Npc_SdodrDemoMachineDiva Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_SdodrDemoMachineDiva() : base()
		{
		...
		public Npc_SdodrDemoMachineDiva(Npc_SdodrDemoMachineDiva other) : base(other)
		{
		...
		public override Npc_SdodrDemoMachineDiva Clone()
		{
			return new Npc_SdodrDemoMachineDiva(this);
		}
