...
{
	public class GfxPointLightDynamic : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightDynamic Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightDynamic Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightDynamic Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightDynamic Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightDynamic Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightDynamic() : base()
		{
		...
		public GfxPointLightDynamic(GfxPointLightDynamic other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightDynamic Clone()
		{
			return new GfxPointLightDynamic(this);
		}
