...
{
	public class SplMissionStageTreasureA : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplMissionStageTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplMissionStageTreasureA() : base()
		{
		...
		public SplMissionStageTreasureA(SplMissionStageTreasureA other) : base(other)
		{
		...
		public override SplMissionStageTreasureA Clone()
		{
			return new SplMissionStageTreasureA(this);
		}
