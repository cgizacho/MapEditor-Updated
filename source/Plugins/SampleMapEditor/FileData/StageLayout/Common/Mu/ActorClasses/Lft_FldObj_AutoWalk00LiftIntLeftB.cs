...
{
	public class Lft_FldObj_AutoWalk00LiftIntLeftB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftIntLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftIntLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftIntLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftIntLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftIntLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftIntLeftB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftIntLeftB(Lft_FldObj_AutoWalk00LiftIntLeftB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftIntLeftB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftIntLeftB(this);
		}
