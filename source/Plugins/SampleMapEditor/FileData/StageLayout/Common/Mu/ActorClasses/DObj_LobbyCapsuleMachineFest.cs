...
{
	public class DObj_LobbyCapsuleMachineFest : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_LobbyCapsuleMachineFest Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_LobbyCapsuleMachineFest() : base()
		{
		...
		public DObj_LobbyCapsuleMachineFest(DObj_LobbyCapsuleMachineFest other) : base(other)
		{
		...
		public override DObj_LobbyCapsuleMachineFest Clone()
		{
			return new DObj_LobbyCapsuleMachineFest(this);
		}
