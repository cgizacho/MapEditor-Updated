...
{
	public class Fld_Kaisou03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Kaisou03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Kaisou03(Fld_Kaisou03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Kaisou03 Clone()
		{
			return new Fld_Kaisou03(this);
		}
