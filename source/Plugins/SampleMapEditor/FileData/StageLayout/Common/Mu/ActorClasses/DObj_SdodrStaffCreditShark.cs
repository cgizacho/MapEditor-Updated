...
{
	public class DObj_SdodrStaffCreditShark : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrStaffCreditShark Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrStaffCreditShark() : base()
		{
		...
		public DObj_SdodrStaffCreditShark(DObj_SdodrStaffCreditShark other) : base(other)
		{
		...
		public override DObj_SdodrStaffCreditShark Clone()
		{
			return new DObj_SdodrStaffCreditShark(this);
		}
