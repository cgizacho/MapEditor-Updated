...
{
	public class Lft_FldObj_AutoWalk00LiftEndRightA : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftEndRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftEndRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftEndRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftEndRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftEndRightA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftEndRightA() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftEndRightA(Lft_FldObj_AutoWalk00LiftEndRightA other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftEndRightA Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftEndRightA(this);
		}
