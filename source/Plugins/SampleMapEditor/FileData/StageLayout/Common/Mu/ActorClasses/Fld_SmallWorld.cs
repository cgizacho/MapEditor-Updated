...
{
	public class Fld_SmallWorld : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_SmallWorld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SmallWorld(Fld_SmallWorld other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_SmallWorld Clone()
		{
			return new Fld_SmallWorld(this);
		}
