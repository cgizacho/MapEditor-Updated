...
{
	public class DObj_DowneyCarpetSAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_DowneyCarpetSAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_DowneyCarpetSAND() : base()
		{
		...
		public DObj_DowneyCarpetSAND(DObj_DowneyCarpetSAND other) : base(other)
		{
		...
		public override DObj_DowneyCarpetSAND Clone()
		{
			return new DObj_DowneyCarpetSAND(this);
		}
