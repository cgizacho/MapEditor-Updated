...
{
	public class NpcVsJerry_Float_00 : MuObj
	{
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_Float_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_Float_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		public NpcVsJerry_Float_00() : base()
		{
		...
		public NpcVsJerry_Float_00(NpcVsJerry_Float_00 other) : base(other)
		{
			spl__OceanBindableHelperBancParam = other.spl__OceanBindableHelperBancParam.Clone();
		}

		public override NpcVsJerry_Float_00 Clone()
		{
			return new NpcVsJerry_Float_00(this);
		}
