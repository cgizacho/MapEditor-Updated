...
{
	public class D : MuObj
	{
		[BindGUI("IsFreeY", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "D Properties", ColumnIndex = 0, Control = BindControl.Default)]
