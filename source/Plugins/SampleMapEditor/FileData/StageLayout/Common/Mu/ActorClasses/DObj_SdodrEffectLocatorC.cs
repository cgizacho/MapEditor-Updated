...
{
	public class DObj_SdodrEffectLocatorC : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrEffectLocatorC Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrEffectLocatorC() : base()
		{
		...
		public DObj_SdodrEffectLocatorC(DObj_SdodrEffectLocatorC other) : base(other)
		{
		...
		public override DObj_SdodrEffectLocatorC Clone()
		{
			return new DObj_SdodrEffectLocatorC(this);
		}
