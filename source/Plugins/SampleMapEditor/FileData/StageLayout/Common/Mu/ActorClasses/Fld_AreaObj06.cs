...
{
	public class Fld_AreaObj06 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj06 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj06(Fld_AreaObj06 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj06 Clone()
		{
			return new Fld_AreaObj06(this);
		}
