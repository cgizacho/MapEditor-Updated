...
{
	public class NpcVsJerry_SwimWear_01 : MuObj
	{
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_SwimWear_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_SwimWear_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		public NpcVsJerry_SwimWear_01() : base()
		{
		...
		public NpcVsJerry_SwimWear_01(NpcVsJerry_SwimWear_01 other) : base(other)
		{
			spl__OceanBindableHelperBancParam = other.spl__OceanBindableHelperBancParam.Clone();
		}

		public override NpcVsJerry_SwimWear_01 Clone()
		{
			return new NpcVsJerry_SwimWear_01(this);
		}
