...
{
	public class EnemyHohei : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyHohei Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyHohei(EnemyHohei other) : base(other)
		{
		...
		public override EnemyHohei Clone()
		{
			return new EnemyHohei(this);
		}
