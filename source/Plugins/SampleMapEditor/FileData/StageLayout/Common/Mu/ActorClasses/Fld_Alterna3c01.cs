...
{
	public class Fld_Alterna3c01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna3c01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna3c01(Fld_Alterna3c01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna3c01 Clone()
		{
			return new Fld_Alterna3c01(this);
		}
