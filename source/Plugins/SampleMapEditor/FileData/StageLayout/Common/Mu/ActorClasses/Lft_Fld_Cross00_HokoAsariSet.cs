...
{
	public class Lft_Fld_Cross00_HokoAsariSet : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_Fld_Cross00_HokoAsariSet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_Fld_Cross00_HokoAsariSet() : base()
		{
		...
		public Lft_Fld_Cross00_HokoAsariSet(Lft_Fld_Cross00_HokoAsariSet other) : base(other)
		{
		...
		public override Lft_Fld_Cross00_HokoAsariSet Clone()
		{
			return new Lft_Fld_Cross00_HokoAsariSet(this);
		}
