...
{
	public class Fld_Alterna2c03Decoration : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna2c03Decoration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna2c03Decoration() : base()
		{
		...
		public Fld_Alterna2c03Decoration(Fld_Alterna2c03Decoration other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna2c03Decoration Clone()
		{
			return new Fld_Alterna2c03Decoration(this);
		}
