...
{
	public class GfxSpotLight_Info : MuObj
	{
		[BindGUI("AngleDamp", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DistDamp", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxSpotLight_Info Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxSpotLight_Info(GfxSpotLight_Info other) : base(other)
		{
			spl__gfx__LocatorSpotLightBancParam = other.spl__gfx__LocatorSpotLightBancParam.Clone();
		}

		public override GfxSpotLight_Info Clone()
		{
			return new GfxSpotLight_Info(this);
		}
