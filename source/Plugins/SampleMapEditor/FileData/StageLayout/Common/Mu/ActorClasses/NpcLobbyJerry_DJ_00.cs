...
{
	public class NpcLobbyJerry_DJ_00 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcLobbyJerry_DJ_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcLobbyJerry_DJ_00() : base()
		{
		...
		public NpcLobbyJerry_DJ_00(NpcLobbyJerry_DJ_00 other) : base(other)
		{
		...
		public override NpcLobbyJerry_DJ_00 Clone()
		{
			return new NpcLobbyJerry_DJ_00(this);
		}
