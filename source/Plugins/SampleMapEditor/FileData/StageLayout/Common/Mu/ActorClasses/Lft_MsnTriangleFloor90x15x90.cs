...
{
	public class Lft_MsnTriangleFloor90x15x90 : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_MsnTriangleFloor90x15x90 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_MsnTriangleFloor90x15x90() : base()
		{
		...
		public Lft_MsnTriangleFloor90x15x90(Lft_MsnTriangleFloor90x15x90 other) : base(other)
		{
		...
		public override Lft_MsnTriangleFloor90x15x90 Clone()
		{
			return new Lft_MsnTriangleFloor90x15x90(this);
		}
