...
{
	public class DObj_FldObj_Lotus : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldObj_Lotus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldObj_Lotus(DObj_FldObj_Lotus other) : base(other)
		{
		...
		public override DObj_FldObj_Lotus Clone()
		{
			return new DObj_FldObj_Lotus(this);
		}
