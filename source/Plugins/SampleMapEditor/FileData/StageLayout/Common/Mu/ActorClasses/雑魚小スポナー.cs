...
{
	public class 雑魚小スポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "雑魚小スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public 雑魚小スポナー(雑魚小スポナー other) : base(other)
		{
		...
		public override 雑魚小スポナー Clone()
		{
			return new 雑魚小スポナー(this);
		}
