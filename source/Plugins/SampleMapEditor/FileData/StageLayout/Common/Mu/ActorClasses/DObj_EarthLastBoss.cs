...
{
	public class DObj_EarthLastBoss : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_EarthLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_EarthLastBoss() : base()
		{
		...
		public DObj_EarthLastBoss(DObj_EarthLastBoss other) : base(other)
		{
		...
		public override DObj_EarthLastBoss Clone()
		{
			return new DObj_EarthLastBoss(this);
		}
