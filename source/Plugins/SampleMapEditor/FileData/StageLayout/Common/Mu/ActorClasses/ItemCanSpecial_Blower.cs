...
{
	public class ItemCanSpecial_Blower : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_Blower Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_Blower() : base()
		{
		...
		public ItemCanSpecial_Blower(ItemCanSpecial_Blower other) : base(other)
		{
		...
		public override ItemCanSpecial_Blower Clone()
		{
			return new ItemCanSpecial_Blower(this);
		}
