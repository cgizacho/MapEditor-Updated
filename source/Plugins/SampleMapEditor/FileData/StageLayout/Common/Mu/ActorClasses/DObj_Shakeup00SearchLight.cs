...
{
	public class DObj_Shakeup00SearchLight : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Shakeup00SearchLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Shakeup00SearchLight() : base()
		{
		...
		public DObj_Shakeup00SearchLight(DObj_Shakeup00SearchLight other) : base(other)
		{
		...
		public override DObj_Shakeup00SearchLight Clone()
		{
			return new DObj_Shakeup00SearchLight(this);
		}
