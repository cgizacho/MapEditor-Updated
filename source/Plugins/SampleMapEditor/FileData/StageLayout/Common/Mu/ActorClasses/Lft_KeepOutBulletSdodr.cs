...
{
	public class Lft_KeepOutBulletSdodr : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("CreateBlister", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintColAttr", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_KeepOutBulletSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_KeepOutBulletSdodr() : base()
		{
		...
		public Lft_KeepOutBulletSdodr(Lft_KeepOutBulletSdodr other) : base(other)
		{
		...
		public override Lft_KeepOutBulletSdodr Clone()
		{
			return new Lft_KeepOutBulletSdodr(this);
		}
