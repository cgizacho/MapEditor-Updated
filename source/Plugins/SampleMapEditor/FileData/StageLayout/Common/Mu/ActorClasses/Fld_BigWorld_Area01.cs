...
{
	public class Fld_BigWorld_Area01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigWorld_Area01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigWorld_Area01() : base()
		{
		...
		public Fld_BigWorld_Area01(Fld_BigWorld_Area01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigWorld_Area01 Clone()
		{
			return new Fld_BigWorld_Area01(this);
		}
