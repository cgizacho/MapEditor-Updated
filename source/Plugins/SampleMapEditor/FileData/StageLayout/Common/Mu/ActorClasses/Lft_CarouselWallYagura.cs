...
{
	public class Lft_CarouselWallYagura : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_CarouselWallYagura Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_CarouselWallYagura() : base()
		{
		...
		public Lft_CarouselWallYagura(Lft_CarouselWallYagura other) : base(other)
		{
		...
		public override Lft_CarouselWallYagura Clone()
		{
			return new Lft_CarouselWallYagura(this);
		}
