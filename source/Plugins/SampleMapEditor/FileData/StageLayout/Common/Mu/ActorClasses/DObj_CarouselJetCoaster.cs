...
{
	public class DObj_CarouselJetCoaster : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_CarouselJetCoaster Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_CarouselJetCoaster() : base()
		{
		...
		public DObj_CarouselJetCoaster(DObj_CarouselJetCoaster other) : base(other)
		{
		...
		public override DObj_CarouselJetCoaster Clone()
		{
			return new DObj_CarouselJetCoaster(this);
		}
