...
{
	public class Fld_AlternaEX04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaEX04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaEX04(Fld_AlternaEX04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaEX04 Clone()
		{
			return new Fld_AlternaEX04(this);
		}
