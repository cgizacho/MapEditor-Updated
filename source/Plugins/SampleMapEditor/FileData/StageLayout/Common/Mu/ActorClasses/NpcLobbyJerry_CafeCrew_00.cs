...
{
	public class NpcLobbyJerry_CafeCrew_00 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcLobbyJerry_CafeCrew_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcLobbyJerry_CafeCrew_00() : base()
		{
		...
		public NpcLobbyJerry_CafeCrew_00(NpcLobbyJerry_CafeCrew_00 other) : base(other)
		{
		...
		public override NpcLobbyJerry_CafeCrew_00 Clone()
		{
			return new NpcLobbyJerry_CafeCrew_00(this);
		}
