...
{
	public class DObj_PlazaMiniGameDecorationBoard : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaMiniGameDecorationBoard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaMiniGameDecorationBoard() : base()
		{
		...
		public DObj_PlazaMiniGameDecorationBoard(DObj_PlazaMiniGameDecorationBoard other) : base(other)
		{
		...
		public override DObj_PlazaMiniGameDecorationBoard Clone()
		{
			return new DObj_PlazaMiniGameDecorationBoard(this);
		}
