...
{
	public class EnemyTakolienBoostVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienBoostVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienBoostVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienBoostVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienBoostVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienBoostVehicle() : base()
		{
		...
		public EnemyTakolienBoostVehicle(EnemyTakolienBoostVehicle other) : base(other)
		{
		...
		public override EnemyTakolienBoostVehicle Clone()
		{
			return new EnemyTakolienBoostVehicle(this);
		}
