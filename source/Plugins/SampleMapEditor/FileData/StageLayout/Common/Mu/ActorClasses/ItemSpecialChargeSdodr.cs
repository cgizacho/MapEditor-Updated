...
{
	public class ItemSpecialChargeSdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemSpecialChargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemSpecialChargeSdodr() : base()
		{
		...
		public ItemSpecialChargeSdodr(ItemSpecialChargeSdodr other) : base(other)
		{
		...
		public override ItemSpecialChargeSdodr Clone()
		{
			return new ItemSpecialChargeSdodr(this);
		}
