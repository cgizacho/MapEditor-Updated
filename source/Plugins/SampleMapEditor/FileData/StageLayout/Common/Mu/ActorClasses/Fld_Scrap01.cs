...
{
	public class Fld_Scrap01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Scrap01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Scrap01(Fld_Scrap01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Scrap01 Clone()
		{
			return new Fld_Scrap01(this);
		}
