...
{
	public class Lft_FldObj_PivotYaguraCenterDoor : MuObj
	{
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_PivotYaguraCenterDoor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_PivotYaguraCenterDoor() : base()
		{
		...
		public Lft_FldObj_PivotYaguraCenterDoor(Lft_FldObj_PivotYaguraCenterDoor other) : base(other)
		{
		...
		public override Lft_FldObj_PivotYaguraCenterDoor Clone()
		{
			return new Lft_FldObj_PivotYaguraCenterDoor(this);
		}
