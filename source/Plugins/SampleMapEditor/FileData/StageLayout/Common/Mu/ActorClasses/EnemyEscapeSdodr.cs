...
{
	public class EnemyEscapeSdodr : MuObj
	{
		[BindGUI("IsBombEnabledOnEnterEscape", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBombEnabledOnReachNode", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MaxOffsetToNode", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "EnemyEscapeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyEscapeSdodr(EnemyEscapeSdodr other) : base(other)
		{
		...
		public override EnemyEscapeSdodr Clone()
		{
			return new EnemyEscapeSdodr(this);
		}
