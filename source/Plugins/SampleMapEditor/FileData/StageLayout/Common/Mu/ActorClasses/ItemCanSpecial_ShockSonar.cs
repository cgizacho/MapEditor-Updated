...
{
	public class ItemCanSpecial_ShockSonar : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_ShockSonar Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_ShockSonar() : base()
		{
		...
		public ItemCanSpecial_ShockSonar(ItemCanSpecial_ShockSonar other) : base(other)
		{
		...
		public override ItemCanSpecial_ShockSonar Clone()
		{
			return new ItemCanSpecial_ShockSonar(this);
		}
