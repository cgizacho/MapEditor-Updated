...
{
	public class DObj_PhayaoAppleCoop : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PhayaoAppleCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PhayaoAppleCoop() : base()
		{
		...
		public DObj_PhayaoAppleCoop(DObj_PhayaoAppleCoop other) : base(other)
		{
		...
		public override DObj_PhayaoAppleCoop Clone()
		{
			return new DObj_PhayaoAppleCoop(this);
		}
