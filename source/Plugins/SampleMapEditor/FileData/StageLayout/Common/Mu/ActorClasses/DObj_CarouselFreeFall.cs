...
{
	public class DObj_CarouselFreeFall : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_CarouselFreeFall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_CarouselFreeFall() : base()
		{
		...
		public DObj_CarouselFreeFall(DObj_CarouselFreeFall other) : base(other)
		{
		...
		public override DObj_CarouselFreeFall Clone()
		{
			return new DObj_CarouselFreeFall(this);
		}
