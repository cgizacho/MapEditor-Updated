...
{
	public class Fld_CoopLobby : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_CoopLobby Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_CoopLobby(Fld_CoopLobby other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_CoopLobby Clone()
		{
			return new Fld_CoopLobby(this);
		}
