...
{
	public class Fld_AreaObj01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj01(Fld_AreaObj01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj01 Clone()
		{
			return new Fld_AreaObj01(this);
		}
