...
{
	public class Fld_PlayerMake : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Fld_PlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Fld_PlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_PlayerMake(Fld_PlayerMake other) : base(other)
		{
			game__EventPerformerBancParam = other.game__EventPerformerBancParam.Clone();
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_PlayerMake Clone()
		{
			return new Fld_PlayerMake(this);
		}
