...
{
	public class Npc_Mizuta_SAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "Npc_Mizuta_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Npc_Mizuta_SAND(Npc_Mizuta_SAND other) : base(other)
		{
		...
		public override Npc_Mizuta_SAND Clone()
		{
			return new Npc_Mizuta_SAND(this);
		}
