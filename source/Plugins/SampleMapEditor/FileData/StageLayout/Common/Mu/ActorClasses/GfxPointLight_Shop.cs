...
{
	public class GfxPointLight_Shop : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Shop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Shop() : base()
		{
		...
		public GfxPointLight_Shop(GfxPointLight_Shop other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Shop Clone()
		{
			return new GfxPointLight_Shop(this);
		}
