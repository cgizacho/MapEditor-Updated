...
namespace SampleMapEditor
{
	public class Npc_ShoesShop : MuObj
	{
		...
		public Npc_ShoesShop(Npc_ShoesShop other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override Npc_ShoesShop Clone()
		{
			return new Npc_ShoesShop(this);
		}
