...
{
	public class DObj_SdodrPlazaTrainBigrun : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrPlazaTrainBigrun Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrPlazaTrainBigrun() : base()
		{
		...
		public DObj_SdodrPlazaTrainBigrun(DObj_SdodrPlazaTrainBigrun other) : base(other)
		{
		...
		public override DObj_SdodrPlazaTrainBigrun Clone()
		{
			return new DObj_SdodrPlazaTrainBigrun(this);
		}
