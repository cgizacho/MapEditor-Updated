...
{
	public class GfxPointLight_Warehouse : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Warehouse Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Warehouse() : base()
		{
		...
		public GfxPointLight_Warehouse(GfxPointLight_Warehouse other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Warehouse Clone()
		{
			return new GfxPointLight_Warehouse(this);
		}
