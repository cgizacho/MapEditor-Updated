...
{
	public class DObj_FldObj_Upland03_Car : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldObj_Upland03_Car Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldObj_Upland03_Car() : base()
		{
		...
		public DObj_FldObj_Upland03_Car(DObj_FldObj_Upland03_Car other) : base(other)
		{
		...
		public override DObj_FldObj_Upland03_Car Clone()
		{
			return new DObj_FldObj_Upland03_Car(this);
		}
