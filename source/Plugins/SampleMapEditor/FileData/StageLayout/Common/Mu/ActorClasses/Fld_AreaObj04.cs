...
{
	public class Fld_AreaObj04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj04(Fld_AreaObj04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj04 Clone()
		{
			return new Fld_AreaObj04(this);
		}
