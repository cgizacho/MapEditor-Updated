...
{
	public class EnemyTakoHopperHide : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakoHopperHide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakoHopperHide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakoHopperHide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakoHopperHide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakoHopperHide() : base()
		{
		...
		public EnemyTakoHopperHide(EnemyTakoHopperHide other) : base(other)
		{
		...
		public override EnemyTakoHopperHide Clone()
		{
			return new EnemyTakoHopperHide(this);
		}
