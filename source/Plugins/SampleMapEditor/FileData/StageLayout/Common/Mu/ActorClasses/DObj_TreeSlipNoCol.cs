...
{
	public class DObj_TreeSlipNoCol : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_TreeSlipNoCol Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_TreeSlipNoCol() : base()
		{
		...
		public DObj_TreeSlipNoCol(DObj_TreeSlipNoCol other) : base(other)
		{
		...
		public override DObj_TreeSlipNoCol Clone()
		{
			return new DObj_TreeSlipNoCol(this);
		}
