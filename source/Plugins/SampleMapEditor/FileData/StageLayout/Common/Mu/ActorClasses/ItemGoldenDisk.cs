...
{
	public class ItemGoldenDisk : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemGoldenDisk Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemGoldenDisk(ItemGoldenDisk other) : base(other)
		{
		...
		public override ItemGoldenDisk Clone()
		{
			return new ItemGoldenDisk(this);
		}
