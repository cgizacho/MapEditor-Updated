...
{
	public class ItemWeaponBuffDocument : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemWeaponBuffDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemWeaponBuffDocument() : base()
		{
		...
		public ItemWeaponBuffDocument(ItemWeaponBuffDocument other) : base(other)
		{
		...
		public override ItemWeaponBuffDocument Clone()
		{
			return new ItemWeaponBuffDocument(this);
		}
