...
{
	public class GfxPointLight_Cafe : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Cafe() : base()
		{
		...
		public GfxPointLight_Cafe(GfxPointLight_Cafe other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Cafe Clone()
		{
			return new GfxPointLight_Cafe(this);
		}
