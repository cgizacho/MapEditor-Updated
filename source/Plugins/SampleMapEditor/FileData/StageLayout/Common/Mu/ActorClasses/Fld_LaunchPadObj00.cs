...
{
	public class Fld_LaunchPadObj00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_LaunchPadObj00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_LaunchPadObj00() : base()
		{
		...
		public Fld_LaunchPadObj00(Fld_LaunchPadObj00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_LaunchPadObj00 Clone()
		{
			return new Fld_LaunchPadObj00(this);
		}
