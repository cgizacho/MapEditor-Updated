...
{
	public class Fld_Alterna4c08 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna4c08 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna4c08(Fld_Alterna4c08 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna4c08 Clone()
		{
			return new Fld_Alterna4c08(this);
		}
