...
{
	public class Fld_Alterna1n04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna1n04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna1n04(Fld_Alterna1n04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna1n04 Clone()
		{
			return new Fld_Alterna1n04(this);
		}
