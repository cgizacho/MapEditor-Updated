...
{
	public class Lft_FldObj_AutoWalk00LiftCenterA : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftCenterA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftCenterA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftCenterA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftCenterA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftCenterA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftCenterA() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftCenterA(Lft_FldObj_AutoWalk00LiftCenterA other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftCenterA Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftCenterA(this);
		}
