...
{
	public class GfxPointLight_Load : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Load Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Load() : base()
		{
		...
		public GfxPointLight_Load(GfxPointLight_Load other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Load Clone()
		{
			return new GfxPointLight_Load(this);
		}
