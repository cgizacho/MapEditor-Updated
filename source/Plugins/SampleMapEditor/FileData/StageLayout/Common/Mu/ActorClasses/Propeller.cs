...
{
	public class Propeller : MuObj
	{
		[BindGUI("ImpulseOnDamage", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveAcc", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnAcc", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnSpeedMax", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeedMax", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "Propeller Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Propeller(Propeller other) : base(other)
		{
		...
		public override Propeller Clone()
		{
