...
{
	public class Fld_Crater03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Crater03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Crater03(Fld_Crater03 other) : base(other)
		{
		...
		public override Fld_Crater03 Clone()
		{
			return new Fld_Crater03(this);
		}
