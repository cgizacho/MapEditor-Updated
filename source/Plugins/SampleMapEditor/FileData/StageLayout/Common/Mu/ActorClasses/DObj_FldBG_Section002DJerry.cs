...
{
	public class DObj_FldBG_Section002DJerry : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldBG_Section002DJerry Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldBG_Section002DJerry() : base()
		{
		...
		public DObj_FldBG_Section002DJerry(DObj_FldBG_Section002DJerry other) : base(other)
		{
		...
		public override DObj_FldBG_Section002DJerry Clone()
		{
			return new DObj_FldBG_Section002DJerry(this);
		}
