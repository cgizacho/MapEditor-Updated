...
{
	public class NpcPlazaJerry_PlazaCafe_00 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerry_PlazaCafe_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerry_PlazaCafe_00() : base()
		{
		...
		public NpcPlazaJerry_PlazaCafe_00(NpcPlazaJerry_PlazaCafe_00 other) : base(other)
		{
		...
		public override NpcPlazaJerry_PlazaCafe_00 Clone()
		{
			return new NpcPlazaJerry_PlazaCafe_00(this);
		}
