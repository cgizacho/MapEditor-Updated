...
{
	public class SplEnemyZakoLargeSdodr : MuObj
	{
		[BindGUI("MidiLinkNoteNumber", Category = "SplEnemyZakoLargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "SplEnemyZakoLargeSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplEnemyZakoLargeSdodr() : base()
		{
		...
		public SplEnemyZakoLargeSdodr(SplEnemyZakoLargeSdodr other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override SplEnemyZakoLargeSdodr Clone()
		{
			return new SplEnemyZakoLargeSdodr(this);
		}
