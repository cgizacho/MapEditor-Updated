...
{
	public class Fld_Carousel03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Carousel03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Carousel03(Fld_Carousel03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Carousel03 Clone()
		{
			return new Fld_Carousel03(this);
		}
