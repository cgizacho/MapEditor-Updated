...
{
	public class Fld_Yagara : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Yagara Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Yagara(Fld_Yagara other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Yagara Clone()
		{
			return new Fld_Yagara(this);
		}
