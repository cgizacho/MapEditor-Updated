...
{
	public class SoundShape_Box : MuObj
	{
		[BindGUI("Name", Category = "SoundShape_Box Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Name
		{
			get
			{
		...
		public SoundShape_Box(SoundShape_Box other) : base(other)
		{
			game__SoundShapeBancParam = other.game__SoundShapeBancParam.Clone();
		}

		public override SoundShape_Box Clone()
		{
			return new SoundShape_Box(this);
		}
