...
{
	public class Lft_GeneralSlope30x30x60AP : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_GeneralSlope30x30x60AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_GeneralSlope30x30x60AP() : base()
		{
		...
		public Lft_GeneralSlope30x30x60AP(Lft_GeneralSlope30x30x60AP other) : base(other)
		{
		...
		public override Lft_GeneralSlope30x30x60AP Clone()
		{
			return new Lft_GeneralSlope30x30x60AP(this);
		}
