...
{
	public class Fld_BankaraCity : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BankaraCity Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BankaraCity(Fld_BankaraCity other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BankaraCity Clone()
		{
			return new Fld_BankaraCity(this);
		}
