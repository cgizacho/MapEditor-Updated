...
{
	public class NpcPlazaJerry_AssistantDirector_01 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerry_AssistantDirector_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerry_AssistantDirector_01() : base()
		{
		...
		public NpcPlazaJerry_AssistantDirector_01(NpcPlazaJerry_AssistantDirector_01 other) : base(other)
		{
		...
		public override NpcPlazaJerry_AssistantDirector_01 Clone()
		{
			return new NpcPlazaJerry_AssistantDirector_01(this);
		}
