...
namespace SampleMapEditor
{
	public class Npc_WeaponShop_Sdodr : MuObj
	{
		...
		public Npc_WeaponShop_Sdodr(Npc_WeaponShop_Sdodr other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override Npc_WeaponShop_Sdodr Clone()
		{
			return new Npc_WeaponShop_Sdodr(this);
		}
