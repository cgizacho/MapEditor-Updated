...
{
	public class SplEnemyShellSdodr : MuObj
	{
		[BindGUI("MidiLinkNoteNumber", Category = "SplEnemyShellSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "SplEnemyShellSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplEnemyShellSdodr() : base()
		{
		...
		public SplEnemyShellSdodr(SplEnemyShellSdodr other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override SplEnemyShellSdodr Clone()
		{
			return new SplEnemyShellSdodr(this);
		}
