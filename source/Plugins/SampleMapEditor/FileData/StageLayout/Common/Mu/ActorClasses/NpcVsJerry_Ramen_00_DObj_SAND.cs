...
{
	public class NpcVsJerry_Ramen_00_DObj_SAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcVsJerry_Ramen_00_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcVsJerry_Ramen_00_DObj_SAND() : base()
		{
		...
		public NpcVsJerry_Ramen_00_DObj_SAND(NpcVsJerry_Ramen_00_DObj_SAND other) : base(other)
		{
		...
		public override NpcVsJerry_Ramen_00_DObj_SAND Clone()
		{
			return new NpcVsJerry_Ramen_00_DObj_SAND(this);
		}
