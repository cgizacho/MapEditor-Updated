...
{
	public class NpcVsJerry_GeneralLow_04_DObj_SAND_01 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcVsJerry_GeneralLow_04_DObj_SAND_01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcVsJerry_GeneralLow_04_DObj_SAND_01() : base()
		{
		...
		public NpcVsJerry_GeneralLow_04_DObj_SAND_01(NpcVsJerry_GeneralLow_04_DObj_SAND_01 other) : base(other)
		{
		...
		public override NpcVsJerry_GeneralLow_04_DObj_SAND_01 Clone()
		{
			return new NpcVsJerry_GeneralLow_04_DObj_SAND_01(this);
		}
