...
{
	public class Fld_Scrap00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Scrap00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Scrap00(Fld_Scrap00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Scrap00 Clone()
		{
			return new Fld_Scrap00(this);
		}
