...
{
	public class Fld_Shakelift00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakelift00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakelift00(Fld_Shakelift00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakelift00 Clone()
		{
			return new Fld_Shakelift00(this);
		}
