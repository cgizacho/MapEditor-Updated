...
{
	public class Fld_AlternaR05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaR05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaR05(Fld_AlternaR05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaR05 Clone()
		{
			return new Fld_AlternaR05(this);
		}
