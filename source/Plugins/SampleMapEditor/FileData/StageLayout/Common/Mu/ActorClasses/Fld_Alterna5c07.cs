...
{
	public class Fld_Alterna5c07 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna5c07 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna5c07(Fld_Alterna5c07 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna5c07 Clone()
		{
			return new Fld_Alterna5c07(this);
		}
