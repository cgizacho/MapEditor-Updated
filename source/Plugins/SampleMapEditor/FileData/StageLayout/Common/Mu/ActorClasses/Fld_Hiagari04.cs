...
{
	public class Fld_Hiagari04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Hiagari04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Hiagari04(Fld_Hiagari04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Hiagari04 Clone()
		{
			return new Fld_Hiagari04(this);
		}
