...
{
	public class EnemyFlyingHoheiRide : MuObj
	{
		[BindGUI("ExtendFootholdDelaySec", Category = "EnemyFlyingHoheiRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("LifeSpanSec", Category = "EnemyFlyingHoheiRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyFlyingHoheiRide Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyFlyingHoheiRide() : base()
		{
		...
		public EnemyFlyingHoheiRide(EnemyFlyingHoheiRide other) : base(other)
		{
		...
		public override EnemyFlyingHoheiRide Clone()
		{
			return new EnemyFlyingHoheiRide(this);
		}
