...
{
	public class GfxAreaLightPlane : MuObj
	{
		[BindGUI("Color", Category = "GfxAreaLightPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxAreaLightPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxAreaLightPlane(GfxAreaLightPlane other) : base(other)
		{
			game__gfx__LocatorPrimitiveLightBancParam = other.game__gfx__LocatorPrimitiveLightBancParam.Clone();
		}

		public override GfxAreaLightPlane Clone()
		{
			return new GfxAreaLightPlane(this);
		}
