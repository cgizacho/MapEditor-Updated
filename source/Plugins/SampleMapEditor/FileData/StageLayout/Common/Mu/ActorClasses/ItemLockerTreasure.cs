...
{
	public class ItemLockerTreasure : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemLockerTreasure Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemLockerTreasure() : base()
		{
		...
		public ItemLockerTreasure(ItemLockerTreasure other) : base(other)
		{
		...
		public override ItemLockerTreasure Clone()
		{
			return new ItemLockerTreasure(this);
		}
