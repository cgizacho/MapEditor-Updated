...
{
	public class Fld_Shakerail00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakerail00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakerail00(Fld_Shakerail00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakerail00 Clone()
		{
			return new Fld_Shakerail00(this);
		}
