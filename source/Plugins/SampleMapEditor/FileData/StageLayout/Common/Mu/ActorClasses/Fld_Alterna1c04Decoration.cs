...
{
	public class Fld_Alterna1c04Decoration : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna1c04Decoration Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna1c04Decoration() : base()
		{
		...
		public Fld_Alterna1c04Decoration(Fld_Alterna1c04Decoration other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna1c04Decoration Clone()
		{
			return new Fld_Alterna1c04Decoration(this);
		}
