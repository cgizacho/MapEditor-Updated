...
{
	public class SplEnemyZakoSmallSdodr_Tutorial : MuObj
	{
		[BindGUI("MidiLinkNoteNumber", Category = "SplEnemyZakoSmallSdodr_Tutorial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "SplEnemyZakoSmallSdodr_Tutorial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplEnemyZakoSmallSdodr_Tutorial() : base()
		{
		...
		public SplEnemyZakoSmallSdodr_Tutorial(SplEnemyZakoSmallSdodr_Tutorial other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override SplEnemyZakoSmallSdodr_Tutorial Clone()
		{
			return new SplEnemyZakoSmallSdodr_Tutorial(this);
		}
