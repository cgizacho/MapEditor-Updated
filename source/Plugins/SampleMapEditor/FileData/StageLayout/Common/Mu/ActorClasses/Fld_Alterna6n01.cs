...
{
	public class Fld_Alterna6n01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna6n01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna6n01(Fld_Alterna6n01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna6n01 Clone()
		{
			return new Fld_Alterna6n01(this);
		}
