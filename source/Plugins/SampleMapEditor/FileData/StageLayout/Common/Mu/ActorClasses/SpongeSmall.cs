...
{
	public class SpongeSmall : MuObj
	{
		[BindGUI("IsFreeY", Category = "SpongeSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "SpongeSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		public SpongeSmall(SpongeSmall other) : base(other)
		{
		...
		public override SpongeSmall Clone()
		{
			return new SpongeSmall(this);
		}
