...
{
	public class FldObj_WorldContainerSet06 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet06 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet06() : base()
		{
		...
		public FldObj_WorldContainerSet06(FldObj_WorldContainerSet06 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet06 Clone()
		{
			return new FldObj_WorldContainerSet06(this);
		}
