...
{
	public class DObj_PlazaTurbanshellsCaseClose : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaTurbanshellsCaseClose Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaTurbanshellsCaseClose() : base()
		{
		...
		public DObj_PlazaTurbanshellsCaseClose(DObj_PlazaTurbanshellsCaseClose other) : base(other)
		{
		...
		public override DObj_PlazaTurbanshellsCaseClose Clone()
		{
			return new DObj_PlazaTurbanshellsCaseClose(this);
		}
