...
{
	public class SplFieldEnvEffectLocator : MuObj
	{
        [BindGUI("Key Name",
		...
		public SplFieldEnvEffectLocator() : base()
		{
		...
		public SplFieldEnvEffectLocator(SplFieldEnvEffectLocator other) : base(other)
		{
			spl__FieldEnvEffectLocatorBancParam = other.spl__FieldEnvEffectLocatorBancParam.Clone();
		}

		public override SplFieldEnvEffectLocator Clone()
		{
			return new SplFieldEnvEffectLocator(this);
		}
