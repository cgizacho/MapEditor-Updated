...
{
	public class ItemCardKey : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCardKey Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCardKey(ItemCardKey other) : base(other)
		{
		...
		public override ItemCardKey Clone()
		{
			return new ItemCardKey(this);
		}
