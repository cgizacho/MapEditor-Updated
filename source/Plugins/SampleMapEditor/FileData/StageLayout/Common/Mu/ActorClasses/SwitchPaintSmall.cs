...
{
	public class SwitchPaintSmall : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SwitchPaintSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SwitchPaintSmall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SwitchPaintSmall(SwitchPaintSmall other) : base(other)
		{
		...
		public override SwitchPaintSmall Clone()
		{
			return new SwitchPaintSmall(this);
		}
