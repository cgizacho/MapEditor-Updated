...
{
	public class NpcIdolDanceA_SAND : MuObj
	{
		[BindGUI("StageType", Category = "NpcIdolDanceA_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceA_SAND() : base()
		{
		...
		public NpcIdolDanceA_SAND(NpcIdolDanceA_SAND other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override NpcIdolDanceA_SAND Clone()
		{
			return new NpcIdolDanceA_SAND(this);
		}
