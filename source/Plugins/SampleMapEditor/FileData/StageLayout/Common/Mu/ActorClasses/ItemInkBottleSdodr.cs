...
{
	public class ItemInkBottleSdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemInkBottleSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemInkBottleSdodr() : base()
		{
		...
		public ItemInkBottleSdodr(ItemInkBottleSdodr other) : base(other)
		{
		...
		public override ItemInkBottleSdodr Clone()
		{
			return new ItemInkBottleSdodr(this);
		}
