...
{
	public class KebaInkCore_Big : MuObj
	{
		[BindGUI("IsFreeY", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsDisableDynamicLoading", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsForIkuraShootTutorial", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoCore", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsSmallWorldLast", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("NecessarySalmonRoe", Category = "KebaInkCore_Big Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public KebaInkCore_Big(KebaInkCore_Big other) : base(other)
		{
		...
		public override KebaInkCore_Big Clone()
		{
			return new KebaInkCore_Big(this);
		}
