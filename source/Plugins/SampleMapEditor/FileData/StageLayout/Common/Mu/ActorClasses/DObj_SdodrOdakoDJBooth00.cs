...
{
	public class DObj_SdodrOdakoDJBooth00 : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrOdakoDJBooth00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrOdakoDJBooth00() : base()
		{
		...
		public DObj_SdodrOdakoDJBooth00(DObj_SdodrOdakoDJBooth00 other) : base(other)
		{
		...
		public override DObj_SdodrOdakoDJBooth00 Clone()
		{
			return new DObj_SdodrOdakoDJBooth00(this);
		}
