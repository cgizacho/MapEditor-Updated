...
{
	public class EnemyTakolienFixedShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "EnemyTakolienFixedShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakolienFixedShieldVehicle() : base()
		{
		...
		public EnemyTakolienFixedShieldVehicle(EnemyTakolienFixedShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienFixedShieldVehicle Clone()
		{
			return new EnemyTakolienFixedShieldVehicle(this);
		}
