...
{
	public class Lft_IkanikeLongPivot : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_IkanikeLongPivot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_IkanikeLongPivot() : base()
		{
		...
		public Lft_IkanikeLongPivot(Lft_IkanikeLongPivot other) : base(other)
		{
		...
		public override Lft_IkanikeLongPivot Clone()
		{
			return new Lft_IkanikeLongPivot(this);
		}
