...
{
	public class Fld_SdodrEntrance : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "Fld_SdodrEntrance Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "Fld_SdodrEntrance Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "Fld_SdodrEntrance Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrEntrance(Fld_SdodrEntrance other) : base(other)
		{
			game__EventPerformerBancParam = other.game__EventPerformerBancParam.Clone();
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override Fld_SdodrEntrance Clone()
		{
			return new Fld_SdodrEntrance(this);
		}
