...
{
	public class SpongeTall_6p0_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "SpongeTall_6p0_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "SpongeTall_6p0_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		public SpongeTall_6p0_VS(SpongeTall_6p0_VS other) : base(other)
		{
		...
		public override SpongeTall_6p0_VS Clone()
		{
			return new SpongeTall_6p0_VS(this);
		}
