...
{
	public class GfxPointLight_BG_ : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_BG_ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_BG_ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_BG_ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_BG_ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_BG_ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_BG_(GfxPointLight_BG_ other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_BG_ Clone()
		{
			return new GfxPointLight_BG_(this);
		}
