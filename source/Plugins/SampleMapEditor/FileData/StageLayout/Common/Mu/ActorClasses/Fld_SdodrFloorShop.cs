...
{
	public class Fld_SdodrFloorShop : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_SdodrFloorShop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrFloorShop() : base()
		{
		...
		public Fld_SdodrFloorShop(Fld_SdodrFloorShop other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_SdodrFloorShop Clone()
		{
			return new Fld_SdodrFloorShop(this);
		}
