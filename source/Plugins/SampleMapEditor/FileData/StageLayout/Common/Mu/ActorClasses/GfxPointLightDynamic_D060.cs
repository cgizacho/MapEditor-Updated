...
{
	public class GfxPointLightDynamic_D060 : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLightDynamic_D060 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightDynamic_D060() : base()
		{
		...
		public GfxPointLightDynamic_D060(GfxPointLightDynamic_D060 other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightDynamic_D060 Clone()
		{
			return new GfxPointLightDynamic_D060(this);
		}
