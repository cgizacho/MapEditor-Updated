...
{
	public class Fld_Alterna1n02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna1n02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna1n02(Fld_Alterna1n02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna1n02 Clone()
		{
			return new Fld_Alterna1n02(this);
		}
