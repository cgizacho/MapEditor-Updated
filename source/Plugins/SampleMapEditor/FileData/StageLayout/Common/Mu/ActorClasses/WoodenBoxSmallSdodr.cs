...
{
	public class WoodenBoxSmallSdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "WoodenBoxSmallSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public WoodenBoxSmallSdodr() : base()
		{
		...
		public WoodenBoxSmallSdodr(WoodenBoxSmallSdodr other) : base(other)
		{
		...
		public override WoodenBoxSmallSdodr Clone()
		{
			return new WoodenBoxSmallSdodr(this);
		}
