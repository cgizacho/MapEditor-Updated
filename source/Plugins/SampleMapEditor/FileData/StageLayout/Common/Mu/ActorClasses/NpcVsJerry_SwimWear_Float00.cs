...
{
	public class NpcVsJerry_SwimWear_Float00 : MuObj
	{
		[BindGUI("IsOceanBind", Category = "NpcVsJerry_SwimWear_Float00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcVsJerry_SwimWear_Float00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		public NpcVsJerry_SwimWear_Float00() : base()
		{
		...
		public NpcVsJerry_SwimWear_Float00(NpcVsJerry_SwimWear_Float00 other) : base(other)
		{
			spl__OceanBindableHelperBancParam = other.spl__OceanBindableHelperBancParam.Clone();
		}

		public override NpcVsJerry_SwimWear_Float00 Clone()
		{
			return new NpcVsJerry_SwimWear_Float00(this);
		}
