...
{
	public class SpongeTall_4p5_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "SpongeTall_4p5_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "SpongeTall_4p5_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		public SpongeTall_4p5_VS(SpongeTall_4p5_VS other) : base(other)
		{
		...
		public override SpongeTall_4p5_VS Clone()
		{
			return new SpongeTall_4p5_VS(this);
		}
