...
{
	public class DObj_SdodrPlazaHelicopterTurning : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrPlazaHelicopterTurning Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrPlazaHelicopterTurning() : base()
		{
		...
		public DObj_SdodrPlazaHelicopterTurning(DObj_SdodrPlazaHelicopterTurning other) : base(other)
		{
		...
		public override DObj_SdodrPlazaHelicopterTurning Clone()
		{
			return new DObj_SdodrPlazaHelicopterTurning(this);
		}
