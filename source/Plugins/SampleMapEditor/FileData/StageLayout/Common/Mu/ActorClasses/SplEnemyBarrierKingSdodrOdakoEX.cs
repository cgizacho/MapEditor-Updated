...
{
	public class SplEnemyBarrierKingSdodrOdakoEX : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplEnemyBarrierKingSdodrOdakoEX Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "SplEnemyBarrierKingSdodrOdakoEX Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "SplEnemyBarrierKingSdodrOdakoEX Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplEnemyBarrierKingSdodrOdakoEX() : base()
		{
		...
		public SplEnemyBarrierKingSdodrOdakoEX(SplEnemyBarrierKingSdodrOdakoEX other) : base(other)
		{
		...
		public override SplEnemyBarrierKingSdodrOdakoEX Clone()
		{
			return new SplEnemyBarrierKingSdodrOdakoEX(this);
		}
