...
{
	public class Fld_Alterna6Boss04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna6Boss04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna6Boss04() : base()
		{
		...
		public Fld_Alterna6Boss04(Fld_Alterna6Boss04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna6Boss04 Clone()
		{
			return new Fld_Alterna6Boss04(this);
		}
