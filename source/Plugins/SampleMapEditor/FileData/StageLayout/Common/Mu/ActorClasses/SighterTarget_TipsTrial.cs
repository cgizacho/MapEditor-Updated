...
{
	public class SighterTarget_TipsTrial : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_TipsTrial Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_TipsTrial() : base()
		{
		...
		public SighterTarget_TipsTrial(SighterTarget_TipsTrial other) : base(other)
		{
		...
		public override SighterTarget_TipsTrial Clone()
		{
			return new SighterTarget_TipsTrial(this);
		}
