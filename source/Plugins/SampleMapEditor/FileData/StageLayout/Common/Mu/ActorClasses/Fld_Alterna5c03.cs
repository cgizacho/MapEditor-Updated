...
{
	public class Fld_Alterna5c03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna5c03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna5c03(Fld_Alterna5c03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna5c03 Clone()
		{
			return new Fld_Alterna5c03(this);
		}
