...
{
	public class DObj_Npc_MobF_Sdodr : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Npc_MobF_Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Npc_MobF_Sdodr() : base()
		{
		...
		public DObj_Npc_MobF_Sdodr(DObj_Npc_MobF_Sdodr other) : base(other)
		{
		...
		public override DObj_Npc_MobF_Sdodr Clone()
		{
			return new DObj_Npc_MobF_Sdodr(this);
		}
