...
{
	public class Lft_FldObj_AutoWalk00LiftEndLeftA : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftEndLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftEndLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftEndLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftEndLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftEndLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftEndLeftA() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftEndLeftA(Lft_FldObj_AutoWalk00LiftEndLeftA other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftEndLeftA Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftEndLeftA(this);
		}
