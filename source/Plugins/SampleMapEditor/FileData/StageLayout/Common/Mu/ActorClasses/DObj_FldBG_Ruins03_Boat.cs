...
{
	public class DObj_FldBG_Ruins03_Boat : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_FldBG_Ruins03_Boat Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_FldBG_Ruins03_Boat() : base()
		{
		...
		public DObj_FldBG_Ruins03_Boat(DObj_FldBG_Ruins03_Boat other) : base(other)
		{
		...
		public override DObj_FldBG_Ruins03_Boat Clone()
		{
			return new DObj_FldBG_Ruins03_Boat(this);
		}
