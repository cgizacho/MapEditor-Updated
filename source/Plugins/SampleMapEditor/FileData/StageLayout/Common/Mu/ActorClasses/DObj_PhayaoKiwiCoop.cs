...
{
	public class DObj_PhayaoKiwiCoop : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PhayaoKiwiCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PhayaoKiwiCoop() : base()
		{
		...
		public DObj_PhayaoKiwiCoop(DObj_PhayaoKiwiCoop other) : base(other)
		{
		...
		public override DObj_PhayaoKiwiCoop Clone()
		{
			return new DObj_PhayaoKiwiCoop(this);
		}
