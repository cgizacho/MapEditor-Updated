...
namespace SampleMapEditor
{
	public class Npc_KnickKnacksShop : MuObj
	{
		...
		public Npc_KnickKnacksShop(Npc_KnickKnacksShop other) : base(other)
		{
			spl__ShopBindableBancParam = other.spl__ShopBindableBancParam.Clone();
		}

		public override Npc_KnickKnacksShop Clone()
		{
			return new Npc_KnickKnacksShop(this);
		}
