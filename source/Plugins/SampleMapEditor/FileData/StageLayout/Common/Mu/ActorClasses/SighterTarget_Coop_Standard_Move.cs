...
{
	public class SighterTarget_Coop_Standard_Move : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_Coop_Standard_Move Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_Coop_Standard_Move() : base()
		{
		...
		public SighterTarget_Coop_Standard_Move(SighterTarget_Coop_Standard_Move other) : base(other)
		{
		...
		public override SighterTarget_Coop_Standard_Move Clone()
		{
			return new SighterTarget_Coop_Standard_Move(this);
		}
