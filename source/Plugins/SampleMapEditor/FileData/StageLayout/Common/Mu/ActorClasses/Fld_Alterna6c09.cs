...
{
	public class Fld_Alterna6c09 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna6c09 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna6c09(Fld_Alterna6c09 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna6c09 Clone()
		{
			return new Fld_Alterna6c09(this);
		}
