...
{
	public class Fld_Shakehighway00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakehighway00() : base()
		{
		...
		public Fld_Shakehighway00(Fld_Shakehighway00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakehighway00 Clone()
		{
			return new Fld_Shakehighway00(this);
		}
