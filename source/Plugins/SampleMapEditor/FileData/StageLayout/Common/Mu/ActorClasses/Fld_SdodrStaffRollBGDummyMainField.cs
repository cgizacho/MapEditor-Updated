...
{
	public class Fld_SdodrStaffRollBGDummyMainField : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_SdodrStaffRollBGDummyMainField Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrStaffRollBGDummyMainField() : base()
		{
		...
		public Fld_SdodrStaffRollBGDummyMainField(Fld_SdodrStaffRollBGDummyMainField other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_SdodrStaffRollBGDummyMainField Clone()
		{
			return new Fld_SdodrStaffRollBGDummyMainField(this);
		}
