...
{
	public class ItemCanSpecial_UltraShot : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_UltraShot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_UltraShot() : base()
		{
		...
		public ItemCanSpecial_UltraShot(ItemCanSpecial_UltraShot other) : base(other)
		{
		...
		public override ItemCanSpecial_UltraShot Clone()
		{
			return new ItemCanSpecial_UltraShot(this);
		}
