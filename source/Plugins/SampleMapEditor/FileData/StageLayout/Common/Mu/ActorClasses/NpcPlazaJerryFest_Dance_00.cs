...
{
	public class NpcPlazaJerryFest_Dance_00 : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaJerryFest_Dance_00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaJerryFest_Dance_00() : base()
		{
		...
		public NpcPlazaJerryFest_Dance_00(NpcPlazaJerryFest_Dance_00 other) : base(other)
		{
		...
		public override NpcPlazaJerryFest_Dance_00 Clone()
		{
			return new NpcPlazaJerryFest_Dance_00(this);
		}
