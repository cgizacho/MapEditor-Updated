...
{
	public class Lft_FldObj_AutoWalk00LiftEndLeftB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftEndLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftEndLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftEndLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftEndLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftEndLeftB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftEndLeftB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftEndLeftB(Lft_FldObj_AutoWalk00LiftEndLeftB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftEndLeftB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftEndLeftB(this);
		}
