...
{
	public class Lft_LineYaguraKabe : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_LineYaguraKabe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_LineYaguraKabe() : base()
		{
		...
		public Lft_LineYaguraKabe(Lft_LineYaguraKabe other) : base(other)
		{
		...
		public override Lft_LineYaguraKabe Clone()
		{
			return new Lft_LineYaguraKabe(this);
		}
