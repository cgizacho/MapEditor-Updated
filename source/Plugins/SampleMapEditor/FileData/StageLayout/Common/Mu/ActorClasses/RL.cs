...
{
	public class RL : MuObj
	{
		[BindGUI("IsSpawnDirSpecified", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ColorGroupType", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OverwriteMaxHP", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementType", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRail", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		[BindGUI("ReserveNumTable", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "RL Properties", ColumnIndex = 0, Control = BindControl.Default)]
