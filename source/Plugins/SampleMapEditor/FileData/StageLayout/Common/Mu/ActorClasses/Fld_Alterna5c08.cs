...
{
	public class Fld_Alterna5c08 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna5c08 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna5c08(Fld_Alterna5c08 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna5c08 Clone()
		{
			return new Fld_Alterna5c08(this);
		}
