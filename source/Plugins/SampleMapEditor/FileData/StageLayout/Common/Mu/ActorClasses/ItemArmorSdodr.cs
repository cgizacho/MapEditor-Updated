...
{
	public class ItemArmorSdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemArmorSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemArmorSdodr(ItemArmorSdodr other) : base(other)
		{
		...
		public override ItemArmorSdodr Clone()
		{
			return new ItemArmorSdodr(this);
		}
