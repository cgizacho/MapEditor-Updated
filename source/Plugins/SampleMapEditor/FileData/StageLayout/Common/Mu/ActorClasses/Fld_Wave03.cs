...
{
	public class Fld_Wave03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Wave03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Wave03(Fld_Wave03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Wave03 Clone()
		{
			return new Fld_Wave03(this);
		}
