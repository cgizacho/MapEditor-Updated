...
{
	public class ItemCanSpecial_Skewer : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_Skewer Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_Skewer() : base()
		{
		...
		public ItemCanSpecial_Skewer(ItemCanSpecial_Skewer other) : base(other)
		{
		...
		public override ItemCanSpecial_Skewer Clone()
		{
			return new ItemCanSpecial_Skewer(this);
		}
