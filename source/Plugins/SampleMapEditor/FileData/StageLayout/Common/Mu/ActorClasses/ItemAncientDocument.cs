...
{
	public class ItemAncientDocument : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemAncientDocument Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemAncientDocument() : base()
		{
		...
		public ItemAncientDocument(ItemAncientDocument other) : base(other)
		{
		...
		public override ItemAncientDocument Clone()
		{
			return new ItemAncientDocument(this);
		}
