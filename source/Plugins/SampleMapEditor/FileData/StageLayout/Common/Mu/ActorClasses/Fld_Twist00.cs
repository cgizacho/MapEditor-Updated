...
{
	public class Fld_Twist00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Twist00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Twist00(Fld_Twist00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Twist00 Clone()
		{
			return new Fld_Twist00(this);
		}
