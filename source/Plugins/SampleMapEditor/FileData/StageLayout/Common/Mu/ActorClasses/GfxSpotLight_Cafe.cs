...
{
	public class GfxSpotLight_Cafe : MuObj
	{
		[BindGUI("AngleDamp", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DistDamp", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxSpotLight_Cafe Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxSpotLight_Cafe(GfxSpotLight_Cafe other) : base(other)
		{
			spl__gfx__LocatorSpotLightBancParam = other.spl__gfx__LocatorSpotLightBancParam.Clone();
		}

		public override GfxSpotLight_Cafe Clone()
		{
			return new GfxSpotLight_Cafe(this);
		}
