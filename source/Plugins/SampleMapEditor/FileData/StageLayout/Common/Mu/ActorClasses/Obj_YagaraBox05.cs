...
namespace SampleMapEditor
{
	public class Obj_YagaraBox05 : MuObj
	{
		...
		public Obj_YagaraBox05(Obj_YagaraBox05 other) : base(other)
		{
			spl__WallaObjBancParam = other.spl__WallaObjBancParam.Clone();
		}

		public override Obj_YagaraBox05 Clone()
		{
			return new Obj_YagaraBox05(this);
		}
