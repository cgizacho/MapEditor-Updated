...
{
	public class DObj_Obj_DitchTree : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Obj_DitchTree Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Obj_DitchTree() : base()
		{
		...
		public DObj_Obj_DitchTree(DObj_Obj_DitchTree other) : base(other)
		{
		...
		public override DObj_Obj_DitchTree Clone()
		{
			return new DObj_Obj_DitchTree(this);
		}
