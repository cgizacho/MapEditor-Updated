...
{
	public class EnemyTakolienBoostShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienBoostShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienBoostShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienBoostShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienBoostShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienBoostShieldVehicle() : base()
		{
		...
		public EnemyTakolienBoostShieldVehicle(EnemyTakolienBoostShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienBoostShieldVehicle Clone()
		{
			return new EnemyTakolienBoostShieldVehicle(this);
		}
