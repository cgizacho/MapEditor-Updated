...
{
	public class NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND : MuObj
	{
		[BindGUI("AttCalcType", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND() : base()
		{
		...
		public NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND(NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND other) : base(other)
		{
		...
		public override NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND Clone()
		{
			return new NpcPlazaFesJerry_ShopVisitorChild_DObj_SAND(this);
		}
