...
{
	public class SighterTarget_Coop_Small : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_Coop_Small Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_Coop_Small() : base()
		{
		...
		public SighterTarget_Coop_Small(SighterTarget_Coop_Small other) : base(other)
		{
		...
		public override SighterTarget_Coop_Small Clone()
		{
			return new SighterTarget_Coop_Small(this);
		}
