...
{
	public class Fld_Alterna1c06 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna1c06 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna1c06(Fld_Alterna1c06 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna1c06 Clone()
		{
			return new Fld_Alterna1c06(this);
		}
