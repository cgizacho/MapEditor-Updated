...
{
	public class EnemyTakolienEasyShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienEasyShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienEasyShieldVehicle() : base()
		{
		...
		public EnemyTakolienEasyShieldVehicle(EnemyTakolienEasyShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienEasyShieldVehicle Clone()
		{
			return new EnemyTakolienEasyShieldVehicle(this);
		}
