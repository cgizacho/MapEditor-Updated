...
{
	public class DObj_SalmonBouyAsparagus : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SalmonBouyAsparagus Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SalmonBouyAsparagus() : base()
		{
		...
		public DObj_SalmonBouyAsparagus(DObj_SalmonBouyAsparagus other) : base(other)
		{
		...
		public override DObj_SalmonBouyAsparagus Clone()
		{
			return new DObj_SalmonBouyAsparagus(this);
		}
