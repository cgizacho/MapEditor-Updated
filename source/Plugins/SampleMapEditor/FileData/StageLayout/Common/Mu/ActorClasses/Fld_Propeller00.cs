...
{
	public class Fld_Propeller00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Propeller00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Propeller00(Fld_Propeller00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Propeller00 Clone()
		{
			return new Fld_Propeller00(this);
		}
