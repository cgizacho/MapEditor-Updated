...
{
	public class Fld_Alterna4c05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna4c05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna4c05(Fld_Alterna4c05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna4c05 Clone()
		{
			return new Fld_Alterna4c05(this);
		}
