...
{
	public class ItemCanSpecial_Chariot : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_Chariot Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_Chariot() : base()
		{
		...
		public ItemCanSpecial_Chariot(ItemCanSpecial_Chariot other) : base(other)
		{
		...
		public override ItemCanSpecial_Chariot Clone()
		{
			return new ItemCanSpecial_Chariot(this);
		}
