...
{
	public class DemoLight１ : MuObj
	{
		[BindGUI("DampParam", Category = "DemoLight１ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "DemoLight１ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "DemoLight１ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "DemoLight１ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "DemoLight１ Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DemoLight１(DemoLight１ other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override DemoLight１ Clone()
		{
			return new DemoLight１(this);
		}
