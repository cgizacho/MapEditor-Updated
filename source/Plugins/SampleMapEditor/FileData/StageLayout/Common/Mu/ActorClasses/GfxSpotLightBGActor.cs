...
{
	public class GfxSpotLightBGActor : MuObj
	{
		[BindGUI("AngleDamp", Category = "GfxSpotLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxSpotLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DistDamp", Category = "GfxSpotLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxSpotLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxSpotLightBGActor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxSpotLightBGActor() : base()
		{
		...
		public GfxSpotLightBGActor(GfxSpotLightBGActor other) : base(other)
		{
			spl__gfx__LocatorSpotLightBancParam = other.spl__gfx__LocatorSpotLightBancParam.Clone();
		}

		public override GfxSpotLightBGActor Clone()
		{
			return new GfxSpotLightBGActor(this);
		}
