...
{
	public class FldObj_WorldContainerSet00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "FldObj_WorldContainerSet00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public FldObj_WorldContainerSet00() : base()
		{
		...
		public FldObj_WorldContainerSet00(FldObj_WorldContainerSet00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override FldObj_WorldContainerSet00 Clone()
		{
			return new FldObj_WorldContainerSet00(this);
		}
