...
{
	public class ItemDroneBatterySdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemDroneBatterySdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemDroneBatterySdodr() : base()
		{
		...
		public ItemDroneBatterySdodr(ItemDroneBatterySdodr other) : base(other)
		{
		...
		public override ItemDroneBatterySdodr Clone()
		{
			return new ItemDroneBatterySdodr(this);
		}
