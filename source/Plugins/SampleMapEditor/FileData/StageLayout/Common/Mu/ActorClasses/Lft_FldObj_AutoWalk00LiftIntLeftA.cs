...
{
	public class Lft_FldObj_AutoWalk00LiftIntLeftA : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftIntLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftIntLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftIntLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftIntLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftIntLeftA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftIntLeftA() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftIntLeftA(Lft_FldObj_AutoWalk00LiftIntLeftA other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftIntLeftA Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftIntLeftA(this);
		}
