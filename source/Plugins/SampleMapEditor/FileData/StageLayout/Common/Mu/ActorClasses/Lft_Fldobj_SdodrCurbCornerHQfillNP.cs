...
{
	public class Lft_Fldobj_SdodrCurbCornerHQfillNP : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("CreateBlister", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintColAttr", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_Fldobj_SdodrCurbCornerHQfillNP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_Fldobj_SdodrCurbCornerHQfillNP() : base()
		{
		...
		public Lft_Fldobj_SdodrCurbCornerHQfillNP(Lft_Fldobj_SdodrCurbCornerHQfillNP other) : base(other)
		{
		...
		public override Lft_Fldobj_SdodrCurbCornerHQfillNP Clone()
		{
			return new Lft_Fldobj_SdodrCurbCornerHQfillNP(this);
		}
