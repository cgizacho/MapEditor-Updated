...
{
	public class Fld_Ruins03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Ruins03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Ruins03(Fld_Ruins03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Ruins03 Clone()
		{
			return new Fld_Ruins03(this);
		}
