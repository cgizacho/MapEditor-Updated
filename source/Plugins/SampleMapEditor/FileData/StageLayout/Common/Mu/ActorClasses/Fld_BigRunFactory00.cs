...
{
	public class Fld_BigRunFactory00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunFactory00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunFactory00() : base()
		{
		...
		public Fld_BigRunFactory00(Fld_BigRunFactory00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunFactory00 Clone()
		{
			return new Fld_BigRunFactory00(this);
		}
