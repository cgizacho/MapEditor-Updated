...
{
	public class DObj_Scrap01Guillotine : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Scrap01Guillotine Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Scrap01Guillotine() : base()
		{
		...
		public DObj_Scrap01Guillotine(DObj_Scrap01Guillotine other) : base(other)
		{
		...
		public override DObj_Scrap01Guillotine Clone()
		{
			return new DObj_Scrap01Guillotine(this);
		}
