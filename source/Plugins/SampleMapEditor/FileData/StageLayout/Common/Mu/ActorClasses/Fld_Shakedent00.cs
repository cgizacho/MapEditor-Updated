...
{
	public class Fld_Shakedent00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakedent00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakedent00(Fld_Shakedent00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakedent00 Clone()
		{
			return new Fld_Shakedent00(this);
		}
