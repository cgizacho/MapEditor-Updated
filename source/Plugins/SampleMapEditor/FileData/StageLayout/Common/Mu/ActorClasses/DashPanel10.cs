...
{
	public class DashPanel10 : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "DashPanel10 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "DashPanel10 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DashPanel10(DashPanel10 other) : base(other)
		{
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override DashPanel10 Clone()
		{
			return new DashPanel10(this);
		}
