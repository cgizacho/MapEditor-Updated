...
{
	public class DObj_MsnMorayKingSign : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_MsnMorayKingSign Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_MsnMorayKingSign() : base()
		{
		...
		public DObj_MsnMorayKingSign(DObj_MsnMorayKingSign other) : base(other)
		{
		...
		public override DObj_MsnMorayKingSign Clone()
		{
			return new DObj_MsnMorayKingSign(this);
		}
