...
{
	public class Fld_AlternaR04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaR04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaR04(Fld_AlternaR04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaR04 Clone()
		{
			return new Fld_AlternaR04(this);
		}
