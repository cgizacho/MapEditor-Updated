...
{
	public class Fld_BigRunUpland03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunUpland03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunUpland03() : base()
		{
		...
		public Fld_BigRunUpland03(Fld_BigRunUpland03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunUpland03 Clone()
		{
			return new Fld_BigRunUpland03(this);
		}
