...
{
	public class GfxPointLight_Parking : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Parking Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Parking() : base()
		{
		...
		public GfxPointLight_Parking(GfxPointLight_Parking other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Parking Clone()
		{
			return new GfxPointLight_Parking(this);
		}
