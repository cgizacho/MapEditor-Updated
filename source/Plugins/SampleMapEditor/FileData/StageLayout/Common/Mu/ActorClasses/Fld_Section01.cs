...
{
	public class Fld_Section01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Section01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Section01(Fld_Section01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Section01 Clone()
		{
			return new Fld_Section01(this);
		}
