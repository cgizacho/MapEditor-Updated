...
{
	public class Fld_SdodrPlazaOrderSecond : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_SdodrPlazaOrderSecond Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "Fld_SdodrPlazaOrderSecond Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "Fld_SdodrPlazaOrderSecond Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrPlazaOrderSecond() : base()
		{
		...
		public Fld_SdodrPlazaOrderSecond(Fld_SdodrPlazaOrderSecond other) : base(other)
		{
		...
		public override Fld_SdodrPlazaOrderSecond Clone()
		{
			return new Fld_SdodrPlazaOrderSecond(this);
		}
