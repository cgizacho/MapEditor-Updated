...
{
	public class GfxPointLight_Load_Red : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Load_Red Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Load_Red() : base()
		{
		...
		public GfxPointLight_Load_Red(GfxPointLight_Load_Red other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Load_Red Clone()
		{
			return new GfxPointLight_Load_Red(this);
		}
