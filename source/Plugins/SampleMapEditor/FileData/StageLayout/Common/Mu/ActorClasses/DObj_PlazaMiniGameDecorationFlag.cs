...
{
	public class DObj_PlazaMiniGameDecorationFlag : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaMiniGameDecorationFlag Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaMiniGameDecorationFlag() : base()
		{
		...
		public DObj_PlazaMiniGameDecorationFlag(DObj_PlazaMiniGameDecorationFlag other) : base(other)
		{
		...
		public override DObj_PlazaMiniGameDecorationFlag Clone()
		{
			return new DObj_PlazaMiniGameDecorationFlag(this);
		}
