...
{
	public class Fld_Hiagari03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Hiagari03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Hiagari03(Fld_Hiagari03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Hiagari03 Clone()
		{
			return new Fld_Hiagari03(this);
		}
