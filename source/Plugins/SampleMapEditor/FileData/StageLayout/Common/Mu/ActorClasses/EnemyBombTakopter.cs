...
{
	public class EnemyBombTakopter : MuObj
	{
		[BindGUI("IsFixedMode", Category = "EnemyBombTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyBombTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyBombTakopter(EnemyBombTakopter other) : base(other)
		{
		...
		public override EnemyBombTakopter Clone()
		{
			return new EnemyBombTakopter(this);
		}
