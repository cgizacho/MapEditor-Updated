...
{
	public class DObj_SdodrPlazaVehicle : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrPlazaVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrPlazaVehicle() : base()
		{
		...
		public DObj_SdodrPlazaVehicle(DObj_SdodrPlazaVehicle other) : base(other)
		{
		...
		public override DObj_SdodrPlazaVehicle Clone()
		{
			return new DObj_SdodrPlazaVehicle(this);
		}
