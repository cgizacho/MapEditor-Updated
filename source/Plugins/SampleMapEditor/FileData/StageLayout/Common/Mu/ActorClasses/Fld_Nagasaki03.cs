...
{
	public class Fld_Nagasaki03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Nagasaki03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Nagasaki03(Fld_Nagasaki03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Nagasaki03 Clone()
		{
			return new Fld_Nagasaki03(this);
		}
