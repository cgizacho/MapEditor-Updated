...
{
	public class DObj_PlazaHelicopterHovering : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaHelicopterHovering Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaHelicopterHovering() : base()
		{
		...
		public DObj_PlazaHelicopterHovering(DObj_PlazaHelicopterHovering other) : base(other)
		{
		...
		public override DObj_PlazaHelicopterHovering Clone()
		{
			return new DObj_PlazaHelicopterHovering(this);
		}
