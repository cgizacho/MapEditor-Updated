...
{
	public class Lft_MsnOctagonPiller15x60x15AP : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_MsnOctagonPiller15x60x15AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_MsnOctagonPiller15x60x15AP() : base()
		{
		...
		public Lft_MsnOctagonPiller15x60x15AP(Lft_MsnOctagonPiller15x60x15AP other) : base(other)
		{
		...
		public override Lft_MsnOctagonPiller15x60x15AP Clone()
		{
			return new Lft_MsnOctagonPiller15x60x15AP(this);
		}
