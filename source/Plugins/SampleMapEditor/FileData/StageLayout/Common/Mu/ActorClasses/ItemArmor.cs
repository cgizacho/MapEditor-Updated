...
{
	public class ItemArmor : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemArmor Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemArmor(ItemArmor other) : base(other)
		{
		...
		public override ItemArmor Clone()
		{
