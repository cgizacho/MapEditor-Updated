...
{
	public class DObj_Npc_JerryPlayerMake : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Npc_JerryPlayerMake Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Npc_JerryPlayerMake() : base()
		{
		...
		public DObj_Npc_JerryPlayerMake(DObj_Npc_JerryPlayerMake other) : base(other)
		{
		...
		public override DObj_Npc_JerryPlayerMake Clone()
		{
			return new DObj_Npc_JerryPlayerMake(this);
		}
