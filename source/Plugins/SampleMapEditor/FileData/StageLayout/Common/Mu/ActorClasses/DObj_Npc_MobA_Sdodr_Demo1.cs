...
{
	public class DObj_Npc_MobA_Sdodr_Demo1 : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Npc_MobA_Sdodr_Demo1 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Npc_MobA_Sdodr_Demo1() : base()
		{
		...
		public DObj_Npc_MobA_Sdodr_Demo1(DObj_Npc_MobA_Sdodr_Demo1 other) : base(other)
		{
		...
		public override DObj_Npc_MobA_Sdodr_Demo1 Clone()
		{
			return new DObj_Npc_MobA_Sdodr_Demo1(this);
		}
