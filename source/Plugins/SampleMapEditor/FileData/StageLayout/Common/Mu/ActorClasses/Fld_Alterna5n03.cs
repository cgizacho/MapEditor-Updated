...
{
	public class Fld_Alterna5n03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna5n03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna5n03(Fld_Alterna5n03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna5n03 Clone()
		{
			return new Fld_Alterna5n03(this);
		}
