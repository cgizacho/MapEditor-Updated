...
{
	public class NpcIdolDanceB_SAND : MuObj
	{
		[BindGUI("StageType", Category = "NpcIdolDanceB_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceB_SAND() : base()
		{
		...
		public NpcIdolDanceB_SAND(NpcIdolDanceB_SAND other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override NpcIdolDanceB_SAND Clone()
		{
			return new NpcIdolDanceB_SAND(this);
		}
