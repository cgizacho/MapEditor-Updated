...
{
	public class EnemyTakopter : MuObj
	{
		[BindGUI("IsFixedMode", Category = "EnemyTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakopter(EnemyTakopter other) : base(other)
		{
		...
		public override EnemyTakopter Clone()
		{
			return new EnemyTakopter(this);
		}
