...
{
	public class DObj_MsnMorayKingWave : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_MsnMorayKingWave Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_MsnMorayKingWave() : base()
		{
		...
		public DObj_MsnMorayKingWave(DObj_MsnMorayKingWave other) : base(other)
		{
		...
		public override DObj_MsnMorayKingWave Clone()
		{
			return new DObj_MsnMorayKingWave(this);
		}
