...
{
	public class Lft_CenterPillarYagura_NoFld : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_CenterPillarYagura_NoFld Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_CenterPillarYagura_NoFld() : base()
		{
		...
		public Lft_CenterPillarYagura_NoFld(Lft_CenterPillarYagura_NoFld other) : base(other)
		{
		...
		public override Lft_CenterPillarYagura_NoFld Clone()
		{
			return new Lft_CenterPillarYagura_NoFld(this);
		}
