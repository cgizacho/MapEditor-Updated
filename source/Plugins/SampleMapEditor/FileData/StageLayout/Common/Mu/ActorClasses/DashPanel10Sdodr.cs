...
{
	public class DashPanel10Sdodr : MuObj
	{
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "DashPanel10Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "DashPanel10Sdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DashPanel10Sdodr(DashPanel10Sdodr other) : base(other)
		{
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override DashPanel10Sdodr Clone()
		{
			return new DashPanel10Sdodr(this);
		}
