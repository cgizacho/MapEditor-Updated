...
{
	public class DObj_VssPropellerNightAirplane : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_VssPropellerNightAirplane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_VssPropellerNightAirplane() : base()
		{
		...
		public DObj_VssPropellerNightAirplane(DObj_VssPropellerNightAirplane other) : base(other)
		{
		...
		public override DObj_VssPropellerNightAirplane Clone()
		{
			return new DObj_VssPropellerNightAirplane(this);
		}
