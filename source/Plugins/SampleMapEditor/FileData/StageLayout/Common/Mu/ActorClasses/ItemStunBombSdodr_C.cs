...
{
	public class ItemStunBombSdodr_C : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemStunBombSdodr_C Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemStunBombSdodr_C() : base()
		{
		...
		public ItemStunBombSdodr_C(ItemStunBombSdodr_C other) : base(other)
		{
		...
		public override ItemStunBombSdodr_C Clone()
		{
			return new ItemStunBombSdodr_C(this);
		}
