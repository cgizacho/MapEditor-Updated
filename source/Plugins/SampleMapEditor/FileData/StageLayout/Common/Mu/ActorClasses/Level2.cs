...
{
	public class Level2 : MuObj
	{
		[BindGUI("IsSpawnDirSpecified", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ColorGroupType", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OverwriteMaxHP", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementType", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRail", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Type", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public string _Type
		{
			get
			{
		...
		[BindGUI("ReserveNumTable", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "Level2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Level2(Level2 other) : base(other)
		{
