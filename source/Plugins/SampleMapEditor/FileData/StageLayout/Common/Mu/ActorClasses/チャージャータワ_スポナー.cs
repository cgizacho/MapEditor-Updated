...
{
	public class チャージャータワ_スポナー : MuObj
	{
		...
		public チャージャータワ_スポナー(チャージャータワ_スポナー other) : base(other)
		{
		...
		public override チャージャータワ_スポナー Clone()
		{
			return new チャージャータワ_スポナー(this);
		}
