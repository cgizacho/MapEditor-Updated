...
{
	public class Fld_AlternaEX03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaEX03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaEX03(Fld_AlternaEX03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaEX03 Clone()
		{
			return new Fld_AlternaEX03(this);
		}
