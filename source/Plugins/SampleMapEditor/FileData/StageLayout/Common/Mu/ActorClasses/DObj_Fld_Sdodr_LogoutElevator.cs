...
{
	public class DObj_Fld_Sdodr_LogoutElevator : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Fld_Sdodr_LogoutElevator Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Fld_Sdodr_LogoutElevator() : base()
		{
		...
		public DObj_Fld_Sdodr_LogoutElevator(DObj_Fld_Sdodr_LogoutElevator other) : base(other)
		{
		...
		public override DObj_Fld_Sdodr_LogoutElevator Clone()
		{
			return new DObj_Fld_Sdodr_LogoutElevator(this);
		}
