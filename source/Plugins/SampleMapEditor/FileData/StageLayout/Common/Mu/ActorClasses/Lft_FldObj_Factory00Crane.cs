...
{
	public class Lft_FldObj_Factory00Crane : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_Factory00Crane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_Factory00Crane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_Factory00Crane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_Factory00Crane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_Factory00Crane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_Factory00Crane() : base()
		{
		...
		public Lft_FldObj_Factory00Crane(Lft_FldObj_Factory00Crane other) : base(other)
		{
		...
		public override Lft_FldObj_Factory00Crane Clone()
		{
			return new Lft_FldObj_Factory00Crane(this);
		}
