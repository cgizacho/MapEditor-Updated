...
{
	public class GfxPointLightDynamic_D040 : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLightDynamic_D040 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightDynamic_D040() : base()
		{
		...
		public GfxPointLightDynamic_D040(GfxPointLightDynamic_D040 other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightDynamic_D040 Clone()
		{
			return new GfxPointLightDynamic_D040(this);
		}
