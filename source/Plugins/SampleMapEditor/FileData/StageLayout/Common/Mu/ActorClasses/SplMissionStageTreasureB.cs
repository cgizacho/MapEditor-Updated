...
{
	public class SplMissionStageTreasureB : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplMissionStageTreasureB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplMissionStageTreasureB() : base()
		{
		...
		public SplMissionStageTreasureB(SplMissionStageTreasureB other) : base(other)
		{
		...
		public override SplMissionStageTreasureB Clone()
		{
			return new SplMissionStageTreasureB(this);
		}
