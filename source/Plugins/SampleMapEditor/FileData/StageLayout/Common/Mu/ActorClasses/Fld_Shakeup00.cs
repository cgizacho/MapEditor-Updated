...
{
	public class Fld_Shakeup00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Shakeup00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Shakeup00(Fld_Shakeup00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Shakeup00 Clone()
		{
			return new Fld_Shakeup00(this);
		}
