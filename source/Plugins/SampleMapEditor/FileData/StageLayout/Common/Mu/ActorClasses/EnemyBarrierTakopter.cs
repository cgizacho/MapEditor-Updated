...
{
	public class EnemyBarrierTakopter : MuObj
	{
		[BindGUI("IsFixedMode", Category = "EnemyBarrierTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyBarrierTakopter Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyBarrierTakopter() : base()
		{
		...
		public EnemyBarrierTakopter(EnemyBarrierTakopter other) : base(other)
		{
		...
		public override EnemyBarrierTakopter Clone()
		{
			return new EnemyBarrierTakopter(this);
		}
