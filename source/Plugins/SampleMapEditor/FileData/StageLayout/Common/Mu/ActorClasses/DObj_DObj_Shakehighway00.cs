...
{
	public class DObj_DObj_Shakehighway00 : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_DObj_Shakehighway00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_DObj_Shakehighway00() : base()
		{
		...
		public DObj_DObj_Shakehighway00(DObj_DObj_Shakehighway00 other) : base(other)
		{
		...
		public override DObj_DObj_Shakehighway00 Clone()
		{
			return new DObj_DObj_Shakehighway00(this);
		}
