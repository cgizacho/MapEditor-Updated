...
{
	public class WoodenBoxHard : MuObj
	{
		[BindGUI("IsFreeY", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "WoodenBoxHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public WoodenBoxHard(WoodenBoxHard other) : base(other)
		{
		...
		public override WoodenBoxHard Clone()
		{
			return new WoodenBoxHard(this);
		}
