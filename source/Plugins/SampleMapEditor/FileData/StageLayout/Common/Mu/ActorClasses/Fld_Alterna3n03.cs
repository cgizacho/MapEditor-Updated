...
{
	public class Fld_Alterna3n03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna3n03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna3n03(Fld_Alterna3n03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna3n03 Clone()
		{
			return new Fld_Alterna3n03(this);
		}
