...
{
	public class EnemyTakolienFixedBounceShieldVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "EnemyTakolienFixedBounceShieldVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyTakolienFixedBounceShieldVehicle() : base()
		{
		...
		public EnemyTakolienFixedBounceShieldVehicle(EnemyTakolienFixedBounceShieldVehicle other) : base(other)
		{
		...
		public override EnemyTakolienFixedBounceShieldVehicle Clone()
		{
			return new EnemyTakolienFixedBounceShieldVehicle(this);
		}
