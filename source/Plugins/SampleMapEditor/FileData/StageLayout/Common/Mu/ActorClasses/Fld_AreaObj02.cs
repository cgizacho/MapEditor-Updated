...
{
	public class Fld_AreaObj02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj02(Fld_AreaObj02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj02 Clone()
		{
			return new Fld_AreaObj02(this);
		}
