...
{
	public class NpcIdolDanceB_Sdodr_SAND : MuObj
	{
		[BindGUI("StageType", Category = "NpcIdolDanceB_Sdodr_SAND Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceB_Sdodr_SAND() : base()
		{
		...
		public NpcIdolDanceB_Sdodr_SAND(NpcIdolDanceB_Sdodr_SAND other) : base(other)
		{
			spl__MusicLinkBancParam = other.spl__MusicLinkBancParam.Clone();
		}

		public override NpcIdolDanceB_Sdodr_SAND Clone()
		{
			return new NpcIdolDanceB_Sdodr_SAND(this);
		}
