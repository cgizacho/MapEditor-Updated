...
{
	public class Fld_Manbou00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Manbou00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Manbou00(Fld_Manbou00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Manbou00 Clone()
		{
			return new Fld_Manbou00(this);
		}
