...
{
	public class ItemArmorLastBoss : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemArmorLastBoss Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemArmorLastBoss(ItemArmorLastBoss other) : base(other)
		{
		...
		public override ItemArmorLastBoss Clone()
		{
			return new ItemArmorLastBoss(this);
		}
