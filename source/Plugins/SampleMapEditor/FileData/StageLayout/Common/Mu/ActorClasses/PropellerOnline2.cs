...
{
	public class PropellerOnline2 : MuObj
	{
		[BindGUI("MoveAcc", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnAcc", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveReturnSpeedMax", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeedMax", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveVelChargeFull", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitFrameEndRail", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint1", Category = "PropellerOnline2 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public PropellerOnline2(PropellerOnline2 other) : base(other)
		{
		...
		public override PropellerOnline2 Clone()
		{
			return new PropellerOnline2(this);
		}
