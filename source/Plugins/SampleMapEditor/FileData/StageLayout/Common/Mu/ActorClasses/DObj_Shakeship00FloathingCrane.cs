...
{
	public class DObj_Shakeship00FloathingCrane : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_Shakeship00FloathingCrane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_Shakeship00FloathingCrane() : base()
		{
		...
		public DObj_Shakeship00FloathingCrane(DObj_Shakeship00FloathingCrane other) : base(other)
		{
		...
		public override DObj_Shakeship00FloathingCrane Clone()
		{
			return new DObj_Shakeship00FloathingCrane(this);
		}
