...
{
	public class DObj_DObj_FesTeamGoods : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_DObj_FesTeamGoods Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_DObj_FesTeamGoods() : base()
		{
		...
		public DObj_DObj_FesTeamGoods(DObj_DObj_FesTeamGoods other) : base(other)
		{
		...
		public override DObj_DObj_FesTeamGoods Clone()
		{
			return new DObj_DObj_FesTeamGoods(this);
		}
