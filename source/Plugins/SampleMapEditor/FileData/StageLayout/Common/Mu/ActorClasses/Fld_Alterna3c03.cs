...
{
	public class Fld_Alterna3c03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna3c03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna3c03(Fld_Alterna3c03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna3c03 Clone()
		{
			return new Fld_Alterna3c03(this);
		}
