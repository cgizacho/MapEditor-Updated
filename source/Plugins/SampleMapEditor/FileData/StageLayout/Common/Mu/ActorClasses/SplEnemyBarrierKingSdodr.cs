...
{
	public class SplEnemyBarrierKingSdodr : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplEnemyBarrierKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkNoteNumber", Category = "SplEnemyBarrierKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MidiLinkTrackName", Category = "SplEnemyBarrierKingSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplEnemyBarrierKingSdodr() : base()
		{
		...
		public SplEnemyBarrierKingSdodr(SplEnemyBarrierKingSdodr other) : base(other)
		{
		...
		public override SplEnemyBarrierKingSdodr Clone()
		{
			return new SplEnemyBarrierKingSdodr(this);
		}
