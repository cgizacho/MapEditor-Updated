...
{
	public class Fld_Alterna3c04 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna3c04 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna3c04(Fld_Alterna3c04 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna3c04 Clone()
		{
			return new Fld_Alterna3c04(this);
		}
