...
{
	public class DObj_CopSectionLightShaft : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_CopSectionLightShaft Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_CopSectionLightShaft() : base()
		{
		...
		public DObj_CopSectionLightShaft(DObj_CopSectionLightShaft other) : base(other)
		{
		...
		public override DObj_CopSectionLightShaft Clone()
		{
			return new DObj_CopSectionLightShaft(this);
		}
