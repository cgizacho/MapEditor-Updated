...
{
	public class GfxPointLight_Building : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_Building() : base()
		{
		...
		public GfxPointLight_Building(GfxPointLight_Building other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_Building Clone()
		{
			return new GfxPointLight_Building(this);
		}
