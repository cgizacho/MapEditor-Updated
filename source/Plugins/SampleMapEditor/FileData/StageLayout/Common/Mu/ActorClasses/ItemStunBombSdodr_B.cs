...
{
	public class ItemStunBombSdodr_B : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemStunBombSdodr_B Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemStunBombSdodr_B() : base()
		{
		...
		public ItemStunBombSdodr_B(ItemStunBombSdodr_B other) : base(other)
		{
		...
		public override ItemStunBombSdodr_B Clone()
		{
			return new ItemStunBombSdodr_B(this);
		}
