...
{
	public class EnemyTakolienEasyVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienEasyVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienEasyVehicle() : base()
		{
		...
		public EnemyTakolienEasyVehicle(EnemyTakolienEasyVehicle other) : base(other)
		{
		...
		public override EnemyTakolienEasyVehicle Clone()
		{
			return new EnemyTakolienEasyVehicle(this);
		}
