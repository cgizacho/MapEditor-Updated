...
{
	public class DemoLightB : MuObj
	{
		[BindGUI("DampParam", Category = "DemoLightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "DemoLightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "DemoLightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "DemoLightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "DemoLightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DemoLightB(DemoLightB other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override DemoLightB Clone()
		{
			return new DemoLightB(this);
		}
