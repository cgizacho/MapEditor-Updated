...
{
	public class Fld_Alterna2Boss02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna2Boss02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna2Boss02() : base()
		{
		...
		public Fld_Alterna2Boss02(Fld_Alterna2Boss02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna2Boss02 Clone()
		{
			return new Fld_Alterna2Boss02(this);
		}
