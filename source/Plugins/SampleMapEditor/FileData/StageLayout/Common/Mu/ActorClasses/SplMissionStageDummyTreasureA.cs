...
{
	public class SplMissionStageDummyTreasureA : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SplMissionStageDummyTreasureA Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplMissionStageDummyTreasureA() : base()
		{
		...
		public SplMissionStageDummyTreasureA(SplMissionStageDummyTreasureA other) : base(other)
		{
		...
		public override SplMissionStageDummyTreasureA Clone()
		{
			return new SplMissionStageDummyTreasureA(this);
		}
