...
{
	public class Fld_AlternaEX01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaEX01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaEX01(Fld_AlternaEX01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaEX01 Clone()
		{
			return new Fld_AlternaEX01(this);
		}
