...
{
	public class Fld_Temple00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Temple00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Temple00(Fld_Temple00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Temple00 Clone()
		{
			return new Fld_Temple00(this);
		}
