...
{
	public class Lft_MsnSlope90x60x150AP : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_MsnSlope90x60x150AP Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_MsnSlope90x60x150AP() : base()
		{
		...
		public Lft_MsnSlope90x60x150AP(Lft_MsnSlope90x60x150AP other) : base(other)
		{
		...
		public override Lft_MsnSlope90x60x150AP Clone()
		{
			return new Lft_MsnSlope90x60x150AP(this);
		}
