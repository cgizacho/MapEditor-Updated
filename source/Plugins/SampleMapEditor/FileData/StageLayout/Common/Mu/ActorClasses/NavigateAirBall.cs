...
{
	public class NavigateAirBall : MuObj
	{
		[BindGUI("AttCalcType", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DisappearFrame", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFirst", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveFrame", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitFrame", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "NavigateAirBall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NavigateAirBall(NavigateAirBall other) : base(other)
		{
		...
		public override NavigateAirBall Clone()
		{
			return new NavigateAirBall(this);
		}
