...
{
	public class Fld_Section00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Section00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Section00(Fld_Section00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Section00 Clone()
		{
			return new Fld_Section00(this);
		}
