...
{
	public class NpcIdolDanceA_Sdodr_SAND_VS : MuObj
	{
		[BindGUI("IsFreeY", Category = "NpcIdolDanceA_Sdodr_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("StageType", Category = "NpcIdolDanceA_Sdodr_SAND_VS Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public NpcIdolDanceA_Sdodr_SAND_VS() : base()
		{
		...
		public NpcIdolDanceA_Sdodr_SAND_VS(NpcIdolDanceA_Sdodr_SAND_VS other) : base(other)
		{
		...
		public override NpcIdolDanceA_Sdodr_SAND_VS Clone()
		{
			return new NpcIdolDanceA_Sdodr_SAND_VS(this);
		}
