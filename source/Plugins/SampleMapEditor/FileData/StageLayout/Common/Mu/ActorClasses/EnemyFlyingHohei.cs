...
{
	public class EnemyFlyingHohei : MuObj
	{
		[BindGUI("ExtendFootholdDelaySec", Category = "EnemyFlyingHohei Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("LifeSpanSec", Category = "EnemyFlyingHohei Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "EnemyFlyingHohei Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public EnemyFlyingHohei(EnemyFlyingHohei other) : base(other)
		{
		...
		public override EnemyFlyingHohei Clone()
		{
			return new EnemyFlyingHohei(this);
		}
