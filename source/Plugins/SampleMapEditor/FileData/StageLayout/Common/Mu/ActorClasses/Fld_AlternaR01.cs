...
{
	public class Fld_AlternaR01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaR01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaR01(Fld_AlternaR01 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaR01 Clone()
		{
			return new Fld_AlternaR01(this);
		}
