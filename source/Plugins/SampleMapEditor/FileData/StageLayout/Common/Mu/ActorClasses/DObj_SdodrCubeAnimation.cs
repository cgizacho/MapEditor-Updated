...
{
	public class DObj_SdodrCubeAnimation : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrCubeAnimation Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrCubeAnimation() : base()
		{
		...
		public DObj_SdodrCubeAnimation(DObj_SdodrCubeAnimation other) : base(other)
		{
		...
		public override DObj_SdodrCubeAnimation Clone()
		{
			return new DObj_SdodrCubeAnimation(this);
		}
