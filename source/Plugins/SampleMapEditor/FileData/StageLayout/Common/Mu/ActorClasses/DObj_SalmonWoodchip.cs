...
{
	public class DObj_SalmonWoodchip : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SalmonWoodchip Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SalmonWoodchip() : base()
		{
		...
		public DObj_SalmonWoodchip(DObj_SalmonWoodchip other) : base(other)
		{
		...
		public override DObj_SalmonWoodchip Clone()
		{
			return new DObj_SalmonWoodchip(this);
		}
