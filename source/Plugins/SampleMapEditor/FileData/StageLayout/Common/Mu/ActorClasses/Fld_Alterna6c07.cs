...
{
	public class Fld_Alterna6c07 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna6c07 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna6c07(Fld_Alterna6c07 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna6c07 Clone()
		{
			return new Fld_Alterna6c07(this);
		}
