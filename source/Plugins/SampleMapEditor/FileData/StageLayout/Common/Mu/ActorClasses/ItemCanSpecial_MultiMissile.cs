...
{
	public class ItemCanSpecial_MultiMissile : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_MultiMissile Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_MultiMissile() : base()
		{
		...
		public ItemCanSpecial_MultiMissile(ItemCanSpecial_MultiMissile other) : base(other)
		{
		...
		public override ItemCanSpecial_MultiMissile Clone()
		{
			return new ItemCanSpecial_MultiMissile(this);
		}
