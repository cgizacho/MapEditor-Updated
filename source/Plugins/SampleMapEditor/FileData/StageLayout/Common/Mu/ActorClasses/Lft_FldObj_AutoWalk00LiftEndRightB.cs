...
{
	public class Lft_FldObj_AutoWalk00LiftEndRightB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftEndRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftEndRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftEndRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftEndRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftEndRightB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftEndRightB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftEndRightB(Lft_FldObj_AutoWalk00LiftEndRightB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftEndRightB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftEndRightB(this);
		}
