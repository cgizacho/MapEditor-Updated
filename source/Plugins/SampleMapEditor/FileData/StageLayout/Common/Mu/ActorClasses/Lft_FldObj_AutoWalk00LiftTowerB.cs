...
{
	public class Lft_FldObj_AutoWalk00LiftTowerB : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Lft_FldObj_AutoWalk00LiftTowerB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_FldObj_AutoWalk00LiftTowerB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_FldObj_AutoWalk00LiftTowerB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_FldObj_AutoWalk00LiftTowerB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_FldObj_AutoWalk00LiftTowerB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_FldObj_AutoWalk00LiftTowerB() : base()
		{
		...
		public Lft_FldObj_AutoWalk00LiftTowerB(Lft_FldObj_AutoWalk00LiftTowerB other) : base(other)
		{
		...
		public override Lft_FldObj_AutoWalk00LiftTowerB Clone()
		{
			return new Lft_FldObj_AutoWalk00LiftTowerB(this);
		}
