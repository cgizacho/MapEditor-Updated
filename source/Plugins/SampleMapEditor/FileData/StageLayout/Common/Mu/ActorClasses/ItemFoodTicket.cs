...
{
	public class ItemFoodTicket : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemFoodTicket Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemFoodTicket(ItemFoodTicket other) : base(other)
		{
		...
		public override ItemFoodTicket Clone()
		{
			return new ItemFoodTicket(this);
		}
