...
{
	public class Lft_UplandPartition : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_UplandPartition Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_UplandPartition() : base()
		{
		...
		public Lft_UplandPartition(Lft_UplandPartition other) : base(other)
		{
		...
		public override Lft_UplandPartition Clone()
		{
			return new Lft_UplandPartition(this);
		}
