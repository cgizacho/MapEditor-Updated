...
{
	public class ItemStunBombSdodr_A : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemStunBombSdodr_A Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemStunBombSdodr_A() : base()
		{
		...
		public ItemStunBombSdodr_A(ItemStunBombSdodr_A other) : base(other)
		{
		...
		public override ItemStunBombSdodr_A Clone()
		{
			return new ItemStunBombSdodr_A(this);
		}
