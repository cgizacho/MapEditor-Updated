...
{
	public class Fld_SdodrRivalKing : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_SdodrRivalKing Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_SdodrRivalKing() : base()
		{
		...
		public Fld_SdodrRivalKing(Fld_SdodrRivalKing other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_SdodrRivalKing Clone()
		{
			return new Fld_SdodrRivalKing(this);
		}
