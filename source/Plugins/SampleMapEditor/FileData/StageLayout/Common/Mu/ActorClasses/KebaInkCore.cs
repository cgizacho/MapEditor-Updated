...
{
	public class KebaInkCore : MuObj
	{
		[BindGUI("IsFreeY", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsDisableDynamicLoading", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsForIkuraShootTutorial", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoCore", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsSmallWorldLast", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("NecessarySalmonRoe", Category = "KebaInkCore Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public KebaInkCore(KebaInkCore other) : base(other)
		{
		...
		public override KebaInkCore Clone()
		{
			return new KebaInkCore(this);
		}
