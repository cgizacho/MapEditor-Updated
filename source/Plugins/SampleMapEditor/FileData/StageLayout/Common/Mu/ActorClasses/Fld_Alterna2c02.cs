...
{
	public class Fld_Alterna2c02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna2c02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna2c02(Fld_Alterna2c02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna2c02 Clone()
		{
			return new Fld_Alterna2c02(this);
		}
