...
{
	public class Fld_Triangle00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Triangle00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Triangle00(Fld_Triangle00 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Triangle00 Clone()
		{
			return new Fld_Triangle00(this);
		}
