...
{
	public class Fld_Alterna6c05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna6c05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna6c05(Fld_Alterna6c05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna6c05 Clone()
		{
			return new Fld_Alterna6c05(this);
		}
