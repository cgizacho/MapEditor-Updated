...
{
	public class ItemCanSpecial_UltraStamp : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_UltraStamp Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_UltraStamp() : base()
		{
		...
		public ItemCanSpecial_UltraStamp(ItemCanSpecial_UltraStamp other) : base(other)
		{
		...
		public override ItemCanSpecial_UltraStamp Clone()
		{
			return new ItemCanSpecial_UltraStamp(this);
		}
