...
{
	public class 跳ねる敵スポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "跳ねる敵スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public 跳ねる敵スポナー(跳ねる敵スポナー other) : base(other)
		{
		...
		public override 跳ねる敵スポナー Clone()
		{
			return new 跳ねる敵スポナー(this);
		}
