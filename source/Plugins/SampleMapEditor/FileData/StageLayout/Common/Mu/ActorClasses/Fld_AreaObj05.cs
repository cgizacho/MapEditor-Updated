...
{
	public class Fld_AreaObj05 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AreaObj05 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AreaObj05(Fld_AreaObj05 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AreaObj05 Clone()
		{
			return new Fld_AreaObj05(this);
		}
