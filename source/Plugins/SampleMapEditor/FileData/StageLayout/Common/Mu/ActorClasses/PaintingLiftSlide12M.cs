...
{
	public class PaintingLiftSlide12M : MuObj
	{
		[BindGUI("AttCalcType", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintRepeatFrame", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _PaintRepeatFrame
		{
			get
			{
				return this.spl__PaintingLiftBancParam.PaintRepeatFrame;
			}

			set
			{
				this.spl__PaintingLiftBancParam.PaintRepeatFrame = value;
			}
		}

		[BindGUI("IsEnableMoveChatteringPrevent", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "PaintingLiftSlide12M Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[ByamlMember("spl__PaintingLiftBancParam")]
		public Mu_spl__PaintingLiftBancParam spl__PaintingLiftBancParam { get; set; }

		[ByamlMember("spl__ailift__AILiftBancParam")]
		public Mu_spl__ailift__AILiftBancParam spl__ailift__AILiftBancParam { get; set; }

		public PaintingLiftSlide12M() : base()
		{
			...
			spl__PaintingLiftBancParam = new Mu_spl__PaintingLiftBancParam();
			spl__ailift__AILiftBancParam = new Mu_spl__ailift__AILiftBancParam();

			Links = new List<Link>();
		}

		public PaintingLiftSlide12M(PaintingLiftSlide12M other) : base(other)
		{
			...
			spl__PaintingLiftBancParam = other.spl__PaintingLiftBancParam.Clone();
			spl__ailift__AILiftBancParam = other.spl__ailift__AILiftBancParam.Clone();
		}

		public override PaintingLiftSlide12M Clone()
		{
			return new PaintingLiftSlide12M(this);
		}
		...
		public override void SaveAdditionalParameters(BymlNode.DictionaryNode SerializedActor)
		{
			...
			this.spl__PaintingLiftBancParam.SaveParameterBank(SerializedActor);
