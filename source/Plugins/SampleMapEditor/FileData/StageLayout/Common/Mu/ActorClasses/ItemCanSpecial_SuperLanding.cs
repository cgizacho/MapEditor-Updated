...
{
	public class ItemCanSpecial_SuperLanding : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCanSpecial_SuperLanding Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCanSpecial_SuperLanding() : base()
		{
		...
		public ItemCanSpecial_SuperLanding(ItemCanSpecial_SuperLanding other) : base(other)
		{
		...
		public override ItemCanSpecial_SuperLanding Clone()
		{
			return new ItemCanSpecial_SuperLanding(this);
		}
