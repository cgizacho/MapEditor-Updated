...
{
	public class Fld_AlternaEX02 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_AlternaEX02 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_AlternaEX02(Fld_AlternaEX02 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_AlternaEX02 Clone()
		{
			return new Fld_AlternaEX02(this);
		}
