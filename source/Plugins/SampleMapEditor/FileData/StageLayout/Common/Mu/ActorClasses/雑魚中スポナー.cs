...
{
	public class 雑魚中スポナー : MuObj
	{
		[BindGUI("ReserveNumTable", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DelaySec", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IntervalSec", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MetaSpawnerId", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SelectPolicyType", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnNumPerTiming", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOrderTable", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnThresholdTable", Category = "雑魚中スポナー Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public 雑魚中スポナー(雑魚中スポナー other) : base(other)
		{
		...
		public override 雑魚中スポナー Clone()
		{
			return new 雑魚中スポナー(this);
		}
