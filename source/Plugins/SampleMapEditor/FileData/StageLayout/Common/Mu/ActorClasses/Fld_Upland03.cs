...
{
	public class Fld_Upland03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Upland03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Upland03(Fld_Upland03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Upland03 Clone()
		{
			return new Fld_Upland03(this);
		}
