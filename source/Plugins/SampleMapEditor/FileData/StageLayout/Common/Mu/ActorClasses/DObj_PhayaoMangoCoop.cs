...
{
	public class DObj_PhayaoMangoCoop : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PhayaoMangoCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PhayaoMangoCoop() : base()
		{
		...
		public DObj_PhayaoMangoCoop(DObj_PhayaoMangoCoop other) : base(other)
		{
		...
		public override DObj_PhayaoMangoCoop Clone()
		{
			return new DObj_PhayaoMangoCoop(this);
		}
