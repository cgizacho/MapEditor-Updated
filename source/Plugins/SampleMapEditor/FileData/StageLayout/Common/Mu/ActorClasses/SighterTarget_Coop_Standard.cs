...
{
	public class SighterTarget_Coop_Standard : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_Coop_Standard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_Coop_Standard() : base()
		{
		...
		public SighterTarget_Coop_Standard(SighterTarget_Coop_Standard other) : base(other)
		{
		...
		public override SighterTarget_Coop_Standard Clone()
		{
			return new SighterTarget_Coop_Standard(this);
		}
