...
{
	public class Fld_Crater01 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Crater01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Crater01(Fld_Crater01 other) : base(other)
		{
		...
		public override Fld_Crater01 Clone()
		{
			return new Fld_Crater01(this);
		}
