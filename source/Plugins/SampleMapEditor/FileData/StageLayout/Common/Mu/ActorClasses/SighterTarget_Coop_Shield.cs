...
{
	public class SighterTarget_Coop_Shield : MuObj
	{
		[BindGUI("AttCalcType", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "SighterTarget_Coop_Shield Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SighterTarget_Coop_Shield() : base()
		{
		...
		public SighterTarget_Coop_Shield(SighterTarget_Coop_Shield other) : base(other)
		{
		...
		public override SighterTarget_Coop_Shield Clone()
		{
			return new SighterTarget_Coop_Shield(this);
		}
