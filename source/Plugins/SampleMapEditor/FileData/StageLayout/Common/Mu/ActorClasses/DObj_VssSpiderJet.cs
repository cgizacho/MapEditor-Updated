...
{
	public class DObj_VssSpiderJet : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_VssSpiderJet Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_VssSpiderJet(DObj_VssSpiderJet other) : base(other)
		{
		...
		public override DObj_VssSpiderJet Clone()
		{
			return new DObj_VssSpiderJet(this);
		}
