...
{
	public class WoodenBoxHardSdodr : MuObj
	{
		[BindGUI("IsFreeY", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "WoodenBoxHardSdodr Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public WoodenBoxHardSdodr() : base()
		{
		...
		public WoodenBoxHardSdodr(WoodenBoxHardSdodr other) : base(other)
		{
		...
		public override WoodenBoxHardSdodr Clone()
		{
			return new WoodenBoxHardSdodr(this);
		}
