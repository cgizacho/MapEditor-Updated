...
{
	public class ShootingBoxL_EnemyBreakable : MuObj
	{
		[BindGUI("IsFreeY", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "ShootingBoxL_EnemyBreakable Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ShootingBoxL_EnemyBreakable() : base()
		{
		...
		public ShootingBoxL_EnemyBreakable(ShootingBoxL_EnemyBreakable other) : base(other)
		{
		...
		public override ShootingBoxL_EnemyBreakable Clone()
		{
			return new ShootingBoxL_EnemyBreakable(this);
		}
