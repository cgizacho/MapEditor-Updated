...
{
	public class EnemyTakolienEasyHideVehicle : MuObj
	{
		[BindGUI("ToRailPoint", Category = "EnemyTakolienEasyHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsCancel", Category = "EnemyTakolienEasyHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PaintFrame", Category = "EnemyTakolienEasyHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Width", Category = "EnemyTakolienEasyHideVehicle Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Width
		{
			get
			{
		...
		public EnemyTakolienEasyHideVehicle() : base()
		{
		...
		public EnemyTakolienEasyHideVehicle(EnemyTakolienEasyHideVehicle other) : base(other)
		{
		...
		public override EnemyTakolienEasyHideVehicle Clone()
		{
			return new EnemyTakolienEasyHideVehicle(this);
		}
