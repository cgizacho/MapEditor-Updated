...
{
	public class DObj_SdodrTowerKingErosion : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrTowerKingErosion Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrTowerKingErosion() : base()
		{
		...
		public DObj_SdodrTowerKingErosion(DObj_SdodrTowerKingErosion other) : base(other)
		{
		...
		public override DObj_SdodrTowerKingErosion Clone()
		{
			return new DObj_SdodrTowerKingErosion(this);
		}
