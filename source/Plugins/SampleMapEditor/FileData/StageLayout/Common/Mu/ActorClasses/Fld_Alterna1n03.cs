...
{
	public class Fld_Alterna1n03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Alterna1n03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Alterna1n03(Fld_Alterna1n03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_Alterna1n03 Clone()
		{
			return new Fld_Alterna1n03(this);
		}
