...
{
	public class Fld_Crater00 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_Crater00 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_Crater00(Fld_Crater00 other) : base(other)
		{
		...
		public override Fld_Crater00 Clone()
		{
			return new Fld_Crater00(this);
		}
