...
{
	public class DObj_TrainInsideBack : MuObj
	{
		[BindGUI("IsActivateOnlyInBeingPerformer", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AttCalcType", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_TrainInsideBack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_TrainInsideBack() : base()
		{
		...
		public DObj_TrainInsideBack(DObj_TrainInsideBack other) : base(other)
		{
		...
		public override DObj_TrainInsideBack Clone()
		{
			return new DObj_TrainInsideBack(this);
		}
