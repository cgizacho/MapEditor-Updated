...
{
	public class DObj_BeaconLightCoop : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_BeaconLightCoop Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_BeaconLightCoop() : base()
		{
		...
		public DObj_BeaconLightCoop(DObj_BeaconLightCoop other) : base(other)
		{
		...
		public override DObj_BeaconLightCoop Clone()
		{
			return new DObj_BeaconLightCoop(this);
		}
