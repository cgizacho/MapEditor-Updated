...
{
	public class GfxPointLight_AirPlane : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLight_AirPlane Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLight_AirPlane() : base()
		{
		...
		public GfxPointLight_AirPlane(GfxPointLight_AirPlane other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLight_AirPlane Clone()
		{
			return new GfxPointLight_AirPlane(this);
		}
