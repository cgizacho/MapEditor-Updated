...
{
	public class DObj_SdodrEffectLocatorB : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_SdodrEffectLocatorB Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_SdodrEffectLocatorB() : base()
		{
		...
		public DObj_SdodrEffectLocatorB(DObj_SdodrEffectLocatorB other) : base(other)
		{
		...
		public override DObj_SdodrEffectLocatorB Clone()
		{
			return new DObj_SdodrEffectLocatorB(this);
		}
