...
{
	public class Lft_MsnEdge45x20x3Fence : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_MsnEdge45x20x3Fence Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_MsnEdge45x20x3Fence() : base()
		{
		...
		public Lft_MsnEdge45x20x3Fence(Lft_MsnEdge45x20x3Fence other) : base(other)
		{
		...
		public override Lft_MsnEdge45x20x3Fence Clone()
		{
			return new Lft_MsnEdge45x20x3Fence(this);
		}
