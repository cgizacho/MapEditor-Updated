...
{
	public class DObj_BunkerCliff01 : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_BunkerCliff01 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_BunkerCliff01() : base()
		{
		...
		public DObj_BunkerCliff01(DObj_BunkerCliff01 other) : base(other)
		{
		...
		public override DObj_BunkerCliff01 Clone()
		{
			return new DObj_BunkerCliff01(this);
		}
