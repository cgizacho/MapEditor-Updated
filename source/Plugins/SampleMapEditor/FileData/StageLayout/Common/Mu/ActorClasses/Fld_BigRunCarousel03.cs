...
{
	public class Fld_BigRunCarousel03 : MuObj
	{
		[BindGUI("IsEventOnly", Category = "Fld_BigRunCarousel03 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Fld_BigRunCarousel03() : base()
		{
		...
		public Fld_BigRunCarousel03(Fld_BigRunCarousel03 other) : base(other)
		{
			spl__EventActorStateBancParam = other.spl__EventActorStateBancParam.Clone();
		}

		public override Fld_BigRunCarousel03 Clone()
		{
			return new Fld_BigRunCarousel03(this);
		}
