...
{
	public class DObj_PlazaSANDLight : MuObj
	{
		[BindGUI("AttCalcType", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsFreeY", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("AnimName", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsOceanBind", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Ratio", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		public float _Ratio
		{
			get
			{
		...
		[BindGUI("ToRailPoint", Category = "DObj_PlazaSANDLight Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public DObj_PlazaSANDLight() : base()
		{
		...
		public DObj_PlazaSANDLight(DObj_PlazaSANDLight other) : base(other)
		{
		...
		public override DObj_PlazaSANDLight Clone()
		{
			return new DObj_PlazaSANDLight(this);
		}
