...
{
	public class SplExplodeSpawnerSdodr_SuperHard : MuObj
	{
		[BindGUI("IsSpawnDirSpecified", Category = "SplExplodeSpawnerSdodr_SuperHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpawnOffsetY", Category = "SplExplodeSpawnerSdodr_SuperHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ReserveNumTable", Category = "SplExplodeSpawnerSdodr_SuperHard Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public SplExplodeSpawnerSdodr_SuperHard() : base()
		{
		...
		public SplExplodeSpawnerSdodr_SuperHard(SplExplodeSpawnerSdodr_SuperHard other) : base(other)
		{
		...
		public override SplExplodeSpawnerSdodr_SuperHard Clone()
		{
			return new SplExplodeSpawnerSdodr_SuperHard(this);
		}
