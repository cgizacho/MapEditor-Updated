...
{
	public class ItemCardPack : MuObj
	{
		[BindGUI("IsFreeY", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PlacementID", Category = "ItemCardPack Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public ItemCardPack(ItemCardPack other) : base(other)
		{
		...
		public override ItemCardPack Clone()
		{
			return new ItemCardPack(this);
		}
