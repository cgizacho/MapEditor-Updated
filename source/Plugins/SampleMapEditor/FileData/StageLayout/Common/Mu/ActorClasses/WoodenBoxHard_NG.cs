...
{
	public class WoodenBoxHard_NG : MuObj
	{
		[BindGUI("IsFreeY", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ConstraintType", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeAxis", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsBindToWorld", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNoHitBetweenBodies", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("HideMode", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraNum", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IkuraValue", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnemyBreakMiss", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsKinematic", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TimeLimit", Category = "WoodenBoxHard_NG Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public WoodenBoxHard_NG(WoodenBoxHard_NG other) : base(other)
		{
		...
		public override WoodenBoxHard_NG Clone()
		{
			return new WoodenBoxHard_NG(this);
		}
