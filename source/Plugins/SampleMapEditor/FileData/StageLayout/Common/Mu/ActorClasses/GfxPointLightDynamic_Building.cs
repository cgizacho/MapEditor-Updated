...
{
	public class GfxPointLightDynamic_Building : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLightDynamic_Building Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightDynamic_Building() : base()
		{
		...
		public GfxPointLightDynamic_Building(GfxPointLightDynamic_Building other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightDynamic_Building Clone()
		{
			return new GfxPointLightDynamic_Building(this);
		}
