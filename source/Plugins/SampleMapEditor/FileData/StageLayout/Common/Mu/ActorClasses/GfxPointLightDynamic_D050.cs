...
{
	public class GfxPointLightDynamic_D050 : MuObj
	{
		[BindGUI("DampParam", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DebugDisplay", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("DiffuseColor", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("Intensity", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnable", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("TurnOnType", Category = "GfxPointLightDynamic_D050 Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public GfxPointLightDynamic_D050() : base()
		{
		...
		public GfxPointLightDynamic_D050(GfxPointLightDynamic_D050 other) : base(other)
		{
			spl__gfx__LocatorPointLightBancParam = other.spl__gfx__LocatorPointLightBancParam.Clone();
		}

		public override GfxPointLightDynamic_D050 Clone()
		{
			return new GfxPointLightDynamic_D050(this);
		}
