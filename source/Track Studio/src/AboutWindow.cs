...
namespace MapStudio
{
    public class AboutWindow : Window
    {
        ...
        public override void Render()
        {
            ...
            ImGui.Text("Map Editor 4.0 - ylwpnk Edition");
            ...
            ImGui.SetCursorPos(bottom);
                ...
                ImGui.Text("");
                ImGui.Text("");
                MapStudio.UI.ImGuiHelper.BoldText("Credits:");
                ImGui.BulletText("heart2zara - New themes, ui changes, bugfixes");
                ImGui.BulletText("graham cracker - Help with source, bug fixes");
                ImGui.Text("");
                MapStudio.UI.ImGuiHelper.BoldText("Original Track Studio Credits:");
                ...
                ImGui.BulletText("OctoSquiddy for the basic Understanding of the Splatoon 3's file system, coding and more stuff");
                ImGui.BulletText("Wheatley for providing Tools");
                ImGui.Text("");
                ImGui.Text("");
