...
namespace MapStudio
{
    public class MainWindow : UIFramework.MainWindow
    {
        ...
        private MenuItem SaveToModFolder;
        ...
        private void Init()
        {
            ...
            SaveToModFolder = new MenuItem("Save To Mod Folder", IconManager.SAVE_ICON, () =>
            {
                Workspace.ActiveWorkspace.SaveFileToModFolder(ValueGetter.ValueGetter.GetModPath());
            })
            { Shortcut = "Ctrl+S" };
        ...
        {
            bool isModPathSet = ValueGetter.ValueGetter.GetModPath() != "";
        ...
        public override void OnKeyDown(KeyboardKeyEventArgs e)
        {
            ...
            if (!e.IsRepeat)
            {
                ...
                //Save shortcut
                else if (state.KeyAlt && e.Key == Key.S)
                {
                    Workspace.ActiveWorkspace?.SaveFileData();
                    return;
                }
